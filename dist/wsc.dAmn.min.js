...
this.window.find("ul.tabs li").first().addClass("active");this.window.find("div.book div.page").first().addClass("active");var a=this;this.window.find("form").bind("change",function(){a.changed=true});this.config.each_page(function(b,g){g.each_item(function(j,k){k._onchange=function(l){a.changed=true}})});this.saveb.click(function(b){a.save();return false});this.closeb.click(function(b){if(a.changed){if(!confirm("Are you sure? You will lose any unsaved changes.")){return false}}a.close();return false});this.scb.click(function(b){a.save();a.close();return false});this.resize()};Chatterbox.Settings.prototype.resize=function(){var a=this.window.find(".inner");var g=a.find("h2");var j=a.find(".bookwrap");var b=a.find("footer");j.height(a.height()-b.outerHeight()-g.outerHeight()-15);this.book.height(j.innerHeight()-this.tabs.outerHeight()-25);this.config.resize()};Chatterbox.Settings.prototype.switch_page=function(b){var g=this.tabs.find("li.active").first();var a=g.prop("id").split("-",1)[0];
g=this.config.page(a.split("_").join(" "));g.hide();b.show()};Chatterbox.Settings.prototype.save=function(){this.config.save(this);this.changed=false};Chatterbox.Settings.prototype.close=function(){this.window.remove();this.manager.nav.settings.open=false;this.manager.nav.settings.window=null;this.config.close(this)};Chatterbox.Settings.Config=function(a){this.manager=a||null;this.pages=[]};Chatterbox.Settings.Config.prototype.find_page=function(b){var j=b.toLowerCase();var g;for(var a in this.pages){g=this.pages[a];if(g.lname==j){return g}}return null};Chatterbox.Settings.Config.prototype.build=function(g,b){g=g||this.manager;for(var a in this.pages){this.pages[a].build(g,b)}};Chatterbox.Settings.Config.prototype.resize=function(){for(var a in this.pages){this.pages[a].resize()}};Chatterbox.Settings.Config.prototype.page=function(b,a){var g=this.find_page(b);a=a||true;if(g==null){g=new Chatterbox.Settings.Page(b,this.manager);if(a){this.pages.push(g)}else{this.pages.unshift(g)}}return g
};Chatterbox.Settings.Config.prototype.each_page=function(j){var g=null;var a=null;for(var b in this.pages){if(!this.pages.hasOwnProperty(b)){continue}g=this.pages[b];a=j(b,g);if(a===false){break}}};Chatterbox.Settings.Config.prototype.save=function(b){for(var a in this.pages){this.pages[a].save(b)}};Chatterbox.Settings.Config.prototype.close=function(b){for(var a in this.pages){this.pages[a].close(b)}};Chatterbox.Settings.Page=function(a,b){this.name=a;this.lname=a.toLowerCase();this.ref=replaceAll(this.lname," ","_");this.items=[];this.itemo={};this.manager=b};Chatterbox.Settings.Page.prototype.build=function(j,b){var a=replaceAll(Chatterbox.template.settings.tab,"{ref}",this.ref);a=replaceAll(a,"{name}",this.name);var g=replaceAll(Chatterbox.template.settings.page,"{ref}",this.ref);g=replaceAll(g,"{page-name}",this.name);b.tabs.append(a);b.book.append(g);this.view=b.book.find("div#"+this.ref+"-page");this.tab=b.tabs.find("li#"+this.ref+"-tab");var g=this;this.tab.find("a").click(function(k){if(g.tab.hasClass("active")){return false
}b.switch_page(g);return false});this.content()};Chatterbox.Settings.Page.prototype.content=function(){for(var a in this.items){this.items[a].build(this.view)}};Chatterbox.Settings.Page.prototype.resize=function(){for(var a in this.items){this.items[a].resize()}};Chatterbox.Settings.Page.prototype.show=function(){if(!this.tab.hasClass("active")){this.tab.addClass("active")}if(!this.view.hasClass("active")){this.view.addClass("active")}this.resize()};Chatterbox.Settings.Page.prototype.hide=function(){if(this.tab.hasClass("active")){this.tab.removeClass("active")}if(this.view.hasClass("active")){this.view.removeClass("active")}};Chatterbox.Settings.Page.prototype.item=function(g,b,a){a=a||false;var j=Chatterbox.Settings.Item.get(g,b,this.manager);if(a){this.items.unshift(j)}else{this.items.push(j)}if(b.hasOwnProperty("ref")){this.itemo[b.ref]=j}return j};Chatterbox.Settings.Page.prototype.get=function(a){if(this.itemo.hasOwnProperty(a)){return this.itemo[a]}return null};Chatterbox.Settings.Page.prototype.each_item=function(j){var g=null;
var a=null;for(var b in this.items){if(!this.items.hasOwnProperty(b)){continue}g=this.items[b];a=j(b,g);if(a===false){break}}};Chatterbox.Settings.Page.prototype.save=function(b){for(var a in this.items){this.items[a].save(b,this)}};Chatterbox.Settings.Page.prototype.close=function(b){for(var a in this.items){this.items[a].close(b,this)}};Chatterbox.Settings.Item=function(b,a,g){this.manager=g||null;this.options=a||{};this.type=b||"base";this.selector=this.type.toLowerCase();this.items=[];this.itemo={};this.view=null;this.val=null;this._onchange=this._event_stub};Chatterbox.Settings.Item.prototype.build=function(m){if(!this.options.hasOwnProperty("ref")){return}var l=this.content();if(l.length==0){return}var a="";if(this.options.hasOwnProperty("wclass")){a=" "+this.options.wclass}var k=Chatterbox.render("settings.item.wrap",{type:this.type.toLowerCase().split(".").join("-"),ref:this.options.ref,"class":a});k=replaceAll(k,"{content}",l);m.append(k);this.view=m.find(".item."+this.options.ref);
this.hooks(this.view);if(!this.options.hasOwnProperty("subitems")){return}var p;var j;var g;var b;for(i in this.options.subitems){p=this.options.subitems[i];j=p[0];g=p[1];sitem=Chatterbox.Settings.Item.get(j,g);b=["stacked"];if(sitem.options.wclass){b.push(sitem.options.wclass)}sitem.options.wclass=b.join(" ");sitem.build(this.view);this.items.push(sitem);if(g.hasOwnProperty("ref")){this.itemo[g.ref]=sitem}}};Chatterbox.Settings.Item.prototype.content=function(){return Chatterbox.render("settings.item."+this.selector,this.options)};Chatterbox.Settings.Item.prototype.resize=function(){for(var a in this.items){this.items[a].resize()}};Chatterbox.Settings.Item.prototype.hooks=function(g){if(!this.options.hasOwnProperty("event")){return}var b=this.options.event;var k=Chatterbox.template.settings.item.get(this.selector);if(k==false){return}if(!k.hasOwnProperty("events")){return}var j=[];for(var a in k.events){j=k.events[a];if(!b.hasOwnProperty(j[0])){continue}g.find(j[1]).bind(j[0],b[j[0]])}};
Chatterbox.Settings.Item.prototype._event_stub=function(){};Chatterbox.Settings.Item.prototype._get_cb=function(a){if(!this.options.hasOwnProperty("event")){return this._event_stub}return this.options.event[a]||this._event_stub};Chatterbox.Settings.Item.prototype._get_ep=function(b){var j=Chatterbox.template.settings.item.get(this.selector);if(j==null){return false}if(!j.hasOwnProperty("events")){return false}var g=[];for(var a in j.events){g=j.events[a];if(g[0]==b){return g}}};Chatterbox.Settings.Item.prototype.save=function(j,k){var l=this._get_ep("inspect");var b=l?this.view.find(l[1]):null;var a=this._get_cb("save");if(typeof a=="function"){a({input:b,item:this,page:k,window:j})}else{for(var g in a){var m=b.hasOwnProperty("slice")?b.slice(g,1):b;a[g]({input:m,item:this,page:k,window:j})}}for(var g in this.items){this.items[g].save(j,k)}};Chatterbox.Settings.Item.prototype.close=function(j,k){var l=this._get_ep("inspect");var b=l?this.view.find(l[1]):null;var a=this._get_cb("close");
if(typeof a=="function"){a({input:b,item:this,page:k,window:j});return}for(var g in a){var m=b.hasOwnProperty("slice")?b.slice(g,1):b;a[g]({input:m,item:this,page:k,window:j})}for(var g in this.items){this.items[g].close(j,k)}};Chatterbox.Settings.Item.get=function(k,q,l,b,a){var j=k.split(".");var m=b||Chatterbox.Settings.Item;var p;for(var g in j){p=j[g];if(!m.hasOwnProperty(p)){m=a||Chatterbox.Settings.Item;break}m=m[p]}return new m(k,q,l)};Chatterbox.Settings.Item.Form=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.form=null;this.fields=[];this.lsection=null;this.fsection=null;this.fieldo={}};Chatterbox.Settings.Item.Form.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.prototype.constructor=Chatterbox.Settings.Item.Form;Chatterbox.Settings.Item.Form.field=function(b,a){return Chatterbox.Settings.Item.get(b,a,this.manager,Chatterbox.Settings.Item.Form,Chatterbox.Settings.Item.Form.Field)};Chatterbox.Settings.Item.Form.prototype.build=function(j){Chatterbox.Settings.Item.prototype.build.call(this,j);
if(this.view==null){return}this.lsection=this.view.find("section.labels");this.fsection=this.view.find("section.fields");if(!this.options.hasOwnProperty("fields")){return}var g;var k;for(var a in this.options.fields){g=this.options.fields[a];k=Chatterbox.Settings.Item.Form.field(g[0],g[1]);this.fields.push(k);k.build(this);if(g[1].hasOwnProperty("ref")){this.fieldo[g[1].ref]=k}}this.form=this.view.find("form");var b=this;this.form.bind("change",function(l){b.change()})};Chatterbox.Settings.Item.Form.prototype.resize=function(){for(var a in this.fields){this.fields[a].resize()}};Chatterbox.Settings.Item.Form.prototype.change=function(){var g={};var j;for(var b in this.fields){j=this.fields[b];g[j.ref]=j.get()}var a=this._get_cb("change");if(typeof a=="function"){a({data:g,form:this})}else{for(var b in a){a[b]({data:g,form:this})}}};Chatterbox.Settings.Item.Form.prototype.save=function(j,l){var k={};var b;for(var g in this.fields){field=this.fields[g];k[field.ref]=field.get()}var a=this._get_cb("save");
if(typeof a=="function"){a({data:k,form:this,page:l,window:j})}else{for(var g in a){a[g]({data:k,form:this,page:l,window:j})}}};Chatterbox.Settings.Item.Form.prototype.close=function(g,k){var j={};var l;for(var b in this.fields){l=this.fields[b];j[l.ref]=l.get()}var a=this._get_cb("close");if(typeof a=="function"){a({data:j,form:this,page:k,window:g})}else{for(var b in a){a[b]({data:j,form:this,page:k,window:g})}}};Chatterbox.Settings.Item.Form.Field=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.ref=this.options.ref||"ref";this.label=null;this.field=null;this.value=""};Chatterbox.Settings.Item.Form.Field.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.Field.prototype.constructor=Chatterbox.Settings.Item.Form.Field;Chatterbox.Settings.Item.Form.Field.prototype.build=function(a){a.lsection.append(Chatterbox.render("settings.item.form.label",{ref:this.ref,label:this.options.label||"","class":(this.options["class"]?" "+this.options["class"]:"")}));this.label=a.lsection.find("label."+this.ref);
...
this.label=g.lsection.find("label."+this.ref);this.lwrap=g.lsection.find("."+this.ref+".label");if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.ref;this.items[b.ref]=""}}g.fsection.append(Chatterbox.render("settings.item.form.field.wrap",{ref:this.ref,field:Chatterbox.render("settings.item.form.field.radio",this.options)}));this.fwrap=g.fsection.find("div."+this.ref+".field");this.field=this.fwrap.find("input:radio");this.value=this.fwrap.find("input[checked]:radio").val();var a=this;this.field.bind("change",function(j){a.value=a.fwrap.find(this).val()})};Chatterbox.Settings.Item.Form.Radio.prototype.resize=function(){this.lwrap.height(this.fwrap.find(".radiobox").height())};Chatterbox.Settings.Item.Form.Radio.prototype.get=function(){return this.value};Chatterbox.Settings.Item.Form.Checkbox=function(b,a){Chatterbox.Settings.Item.Form.Radio.call(this,b,a);this.value=[]};Chatterbox.Settings.Item.Form.Checkbox.prototype=new Chatterbox.Settings.Item.Form.Radio();
Chatterbox.Settings.Item.Form.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Form.Checkbox;Chatterbox.Settings.Item.Form.Checkbox.prototype.build=function(g){g.lsection.append(Chatterbox.render("settings.item.form.label",{ref:this.ref,label:this.options.label||""}));this.label=g.lsection.find("label."+this.ref);this.lwrap=g.lsection.find("."+this.ref+".label");if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.ref;this.items[b.ref]=""}}g.fsection.append(Chatterbox.render("settings.item.form.field.wrap",{ref:this.ref,field:Chatterbox.render("settings.item.form.field.checkbox",this.options)}));this.fwrap=g.fsection.find("div."+this.ref+".field");this.field=this.fwrap.find("input:checkbox");var a=this;this.value=[];this.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())});this.field.bind("change",function(j){a.value=[];a.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())
})})};Chatterbox.Settings.Item.Form.Checkbox.prototype.resize=function(){this.lwrap.height(this.fwrap.find(".checkbox").height())};Chatterbox.Settings.Item.Radio=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.value=""};Chatterbox.Settings.Item.Radio.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Radio.prototype.constructor=Chatterbox.Settings.Item.Radio;Chatterbox.Settings.Item.Radio.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:radio");this.value=this.view.find("input[checked]:radio").val();var a=this;this.field.bind("change",function(j){a.value=a.view.find(this).val()})};Chatterbox.Settings.Item.Checkbox=function(b,a){Chatterbox.Settings.Item.Radio.call(this,b,a);this.value=[]};Chatterbox.Settings.Item.Checkbox.prototype=new Chatterbox.Settings.Item.Radio();Chatterbox.Settings.Item.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Checkbox;
Chatterbox.Settings.Item.Checkbox.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:checkbox");var a=this;this.value=[];this.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())});this.field.bind("change",function(j){a.value=[];a.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())})})};Chatterbox.Settings.Item.Items=function(b,a,g){a=Object.extend({prompt:{title:"Add Item",label:"Item:","submit-button":"Add"}},(a||{}));Chatterbox.Settings.Item.call(this,b,a,g);this.selected=false};Chatterbox.Settings.Item.Items.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Items.prototype.constructor=Chatterbox.Settings.Item.Items;Chatterbox.Settings.Item.Items.prototype.build=function(b){Chatterbox.Settings.Item.prototype.build.call(this,b);
var a=this;this.list=this.view.find("ul");this.buttons=this.view.find("section.buttons p");var g=this.list.find("li");g.click(function(k){var j=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=j.find(".item").html();j.addClass("selected")});g.each(function(j,l){var k=a.list.find(l);k.find("a.close").click(function(m){a.list.find("li.selected").removeClass("selected");a.selected=k.find(".item").html();k.addClass("selected");a.remove_item();return false})});this.buttons.find("a.button.up").click(function(j){a.shift_item(true);return false});this.buttons.find("a.button.down").click(function(j){a.shift_item();return false});this.buttons.find("a.button.add").click(function(j){var k=new Chatterbox.Popup.Prompt(a.manager,{position:[j.clientX-100,j.clientY-50],title:a.options.prompt.title,label:a.options.prompt.label,"submit-button":a.options.prompt["submit-button"],event:{submit:function(l){var p=l.data;if(!p){l.options.event.cancel(l);return}p=p.toLowerCase();var m=a.options.items.indexOf(p);
if(m!=-1){l.options.event.cancel(l);return}a._fevent("add",{item:p});a.refresh();a._onchange({})},cancel:function(l){a._fevent("cancel",{});a.refresh();a._onchange({})}}});k.build();return false});this.buttons.find("a.button.close").click(function(j){a.remove_item();return false})};Chatterbox.Settings.Item.Items.prototype.shift_item=function(b){if(this.selected===false){return}var g=this.options.items.indexOf(this.selected);var a=g+1;if(b){a=g-1}if(g==-1||g>=this.options.items.length){return}if(a<0||a>=this.options.items.length){return}this._fevent((b?"up":"down"),{swap:{"this":{index:g,item:this.options.items[g]},that:{index:a,item:this.options.items[a]}}});this.refresh();this._onchange({});return};Chatterbox.Settings.Item.Items.prototype.remove_item=function(){if(this.selected===false){return false}var a=this.options.items.indexOf(this.selected);if(a==-1||a>=this.options.items.length){return}this._fevent("remove",{index:a,item:this.selected});this.selected=false;this.refresh();this._onchange({})
};Chatterbox.Settings.Item.Items.prototype.refresh=function(){this.view.find("section.mitems").html(Chatterbox.template.settings.krender.manageditems(this.options.items));this.list=this.view.find("ul");this.list.find("li[title="+(this.selected||"").toLowerCase()+"]").addClass("selected");var a=this;var b=this.list.find("li");b.click(function(j){var g=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=g.find(".item").html();g.addClass("selected")});b.each(function(g,k){var j=a.list.find(k);j.find("a.close").click(function(l){a.list.find("li.selected").removeClass("selected");a.selected=j.find(".item").html();j.addClass("selected");a.remove_item();return false})})};Chatterbox.Settings.Item.Items.prototype._fevent=function(b,j){var l=this._get_ep("inspect");var g=l?this.view.find(l[1]):null;var a=this._get_cb(b);if(typeof a=="function"){a({input:g,item:this,args:j})}else{for(var k in a){var m=g.hasOwnProperty("slice")?g.slice(k,1):g;a[k]({input:m,item:this,args:j})
}}};Chatterbox.Settings.Item.Items.prototype.save=function(){this._fevent("save",{items:this.options.items||[]})};Chatterbox.template={};Chatterbox.render=function(p,r,a,b){var k=b||Chatterbox.template;var l={};var m=null;var g=null;if(a!==undefined&&a===true){k=p}else{var q=p.split(".");for(var j in q){g=q[j];if(!k.hasOwnProperty(g)){return""}k=k[g]}}if(k.hasOwnProperty("frame")){m=k;l=k.render||{};k=k.frame;if(m.hasOwnProperty("pre")){if(typeof m.pre=="function"){k=m.pre(k,r)}else{for(i in m.pre){k=m.pre[i](k,r)}}}}for(key in r){k=replaceAll(k,"{"+key+"}",(l[key]||Chatterbox.template.render_stub)(r[key]||""))}if(m!=null){if(m.hasOwnProperty("post")){if(typeof m.post=="function"){k=m.post(k,r)}else{for(i in m.post){k=m.post[i](k,r)}}}}return k};Chatterbox.template.render_stub=function(a){return a};Chatterbox.template.clean=function(a){return function(b,g){for(i in a){b=replaceAll(b,"{"+a[i]+"}","")}return b}};Chatterbox.template.ui='<nav class="tabs"><ul id="chattabs" class="tabs"></ul>        <ul id="tabnav">            <li><a href="#left" class="button iconic arrow_left"></a></li>            <li><a href="#right" class="button iconic arrow_right"></a></li>            <li><a href="#settings" title="Change client settings" class="button iconic cog" id="settings-button"></a></li>        </ul>        </nav>        <div class="chatbook"></div>';
