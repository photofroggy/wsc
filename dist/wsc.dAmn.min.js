...
this.fwrap=g.fsection.find("div."+this.ref+".field");this.field=this.fwrap.find("input:checkbox");var a=this;this.value=[];this.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())});this.field.bind("change",function(j){a.value=[];a.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())})})};Chatterbox.Settings.Item.Form.Checkbox.prototype.resize=function(){this.lwrap.height(this.fwrap.find(".checkbox").height())};Chatterbox.Settings.Item.Radio=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.value=""};Chatterbox.Settings.Item.Radio.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Radio.prototype.constructor=Chatterbox.Settings.Item.Radio;Chatterbox.Settings.Item.Radio.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:radio");
this.value=this.view.find("input[checked]:radio").val();var a=this;this.field.bind("change",function(j){a.value=a.view.find(this).val()})};Chatterbox.Settings.Item.Checkbox=function(b,a){Chatterbox.Settings.Item.Radio.call(this,b,a);this.value=[]};Chatterbox.Settings.Item.Checkbox.prototype=new Chatterbox.Settings.Item.Radio();Chatterbox.Settings.Item.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Checkbox;Chatterbox.Settings.Item.Checkbox.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:checkbox");var a=this;this.value=[];this.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())});this.field.bind("change",function(j){a.value=[];a.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())})})};Chatterbox.Settings.Item.Items=function(b,a,g){a=Object.extend({prompt:{title:"Add Item",label:"Item:","submit-button":"Add"}},(a||{}));
Chatterbox.Settings.Item.call(this,b,a,g);this.selected=false};Chatterbox.Settings.Item.Items.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Items.prototype.constructor=Chatterbox.Settings.Item.Items;Chatterbox.Settings.Item.Items.prototype.build=function(b){Chatterbox.Settings.Item.prototype.build.call(this,b);var a=this;this.list=this.view.find("ul");this.buttons=this.view.find("section.buttons p");var g=this.list.find("li");g.click(function(k){var j=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=j.find(".item").html();j.addClass("selected")});g.each(function(j,l){var k=a.list.find(l);k.find("a.close").click(function(m){a.list.find("li.selected").removeClass("selected");a.selected=k.find(".item").html();k.addClass("selected");a.remove_item();return false})});this.buttons.find("a.button.up").click(function(j){a.shift_item(true);return false});this.buttons.find("a.button.down").click(function(j){a.shift_item();return false});this.buttons.find("a.button.add").click(function(j){var k=new Chatterbox.Popup.Prompt(a.manager,{position:[j.clientX-100,j.clientY-50],title:a.options.prompt.title,label:a.options.prompt.label,"submit-button":a.options.prompt["submit-button"],event:{submit:function(l){var p=l.data;
if(!p){l.options.event.cancel(l);return}p=p.toLowerCase();var m=a.options.items.indexOf(p);if(m!=-1){l.options.event.cancel(l);return}a._fevent("add",{item:p});a.refresh();a._onchange({})},cancel:function(l){a._fevent("cancel",{});a.refresh();a._onchange({})}}});k.build();return false});this.buttons.find("a.button.close").click(function(j){a.remove_item();return false})};Chatterbox.Settings.Item.Items.prototype.shift_item=function(b){if(this.selected===false){return}var g=this.options.items.indexOf(this.selected);var a=g+1;if(b){a=g-1}if(g==-1||g>=this.options.items.length){return}if(a<0||a>=this.options.items.length){return}this._fevent((b?"up":"down"),{swap:{"this":{index:g,item:this.options.items[g]},that:{index:a,item:this.options.items[a]}}});this.refresh();this._onchange({});return};Chatterbox.Settings.Item.Items.prototype.remove_item=function(){if(this.selected===false){return false}var a=this.options.items.indexOf(this.selected);if(a==-1||a>=this.options.items.length){return}this._fevent("remove",{index:a,item:this.selected});
this.selected=false;this.refresh();this._onchange({})};Chatterbox.Settings.Item.Items.prototype.refresh=function(){this.view.find("section.mitems").html(Chatterbox.template.settings.krender.manageditems(this.options.items));this.list=this.view.find("ul");this.list.find("li[title="+(this.selected||"").toLowerCase()+"]").addClass("selected");var a=this;var b=this.list.find("li");b.click(function(j){var g=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=g.find(".item").html();g.addClass("selected")});b.each(function(g,k){var j=a.list.find(k);j.find("a.close").click(function(l){a.list.find("li.selected").removeClass("selected");a.selected=j.find(".item").html();j.addClass("selected");a.remove_item();return false})})};Chatterbox.Settings.Item.Items.prototype._fevent=function(b,j){var l=this._get_ep("inspect");var g=l?this.view.find(l[1]):null;var a=this._get_cb(b);if(typeof a=="function"){a({input:g,item:this,args:j})}else{for(var k in a){var m=g.hasOwnProperty("slice")?g.slice(k,1):g;
a[k]({input:m,item:this,args:j})}}};Chatterbox.Settings.Item.Items.prototype.save=function(){this._fevent("save",{items:this.options.items||[]})};Chatterbox.template={};Chatterbox.render=function(p,r,a,b){var k=b||Chatterbox.template;var l={};var m=null;var g=null;if(a!==undefined&&a===true){k=p}else{var q=p.split(".");for(var j in q){g=q[j];if(!k.hasOwnProperty(g)){return""}k=k[g]}}if(k.hasOwnProperty("frame")){m=k;l=k.render||{};k=k.frame;if(m.hasOwnProperty("pre")){if(typeof m.pre=="function"){k=m.pre(k,r)}else{for(i in m.pre){k=m.pre[i](k,r)}}}}for(key in r){k=replaceAll(k,"{"+key+"}",(l[key]||Chatterbox.template.render_stub)(r[key]||""))}if(m!=null){if(m.hasOwnProperty("post")){if(typeof m.post=="function"){k=m.post(k,r)}else{for(i in m.post){k=m.post[i](k,r)}}}}return k};Chatterbox.template.render_stub=function(a){return a};Chatterbox.template.clean=function(a){return function(b,g){for(i in a){b=replaceAll(b,"{"+a[i]+"}","")}return b}};Chatterbox.template.ui='<nav class="tabs"><ul id="chattabs" class="tabs"></ul>        <ul id="tabnav">            <li><a href="#left" class="button iconic arrow_left"></a></li>            <li><a href="#right" class="button iconic arrow_right"></a></li>            <li><a href="#settings" title="Change client settings" class="button iconic cog" id="settings-button"></a></li>        </ul>        </nav>        <div class="chatbook"></div>';
...
Chatterbox.template.settings.item.form.field.text.pre=Chatterbox.template.settings.item.hint.prep;Chatterbox.template.settings.item.form.field.text.post=Chatterbox.template.clean(["title","text"]);Chatterbox.template.settings.item.form.field.text.render={title:Chatterbox.template.settings.krender.title,text:Chatterbox.template.settings.krender.text};Chatterbox.template.settings.item.form.field.text.frame="{title}<p>                                        {text}                                    </p>";wsc.dAmn={};wsc.dAmn.VERSION="0.3.10";wsc.dAmn.STATE="alpha";wsc.dAmn.Emotes=function(a,g,b){b.emotes.page=null;b.emotes.fint=null;b.emotes.notice=null;b.emotes.fetching=false;b.emotes.loaded=false;b.emotes.picker=new wsc.dAmn.Emotes.Picker(a.ui);b.emotes.picker.build();b.emotes.picker.hide();a.ui.control.add_button({label:"",icon:"user",href:"#emotes",title:"Emote picker.",handler:function(){if(b.emotes.picker.window.css("display")=="none"){b.emotes.picker.show()}else{b.emotes.picker.close()
}}});b.emotes.configure_page=function(k,m){var l=k.settings.page("Emotes");b.emotes.page=l;var p={};p.on=b.emotes.on;var j="";if(p.on){if(!b.emotes.loaded||b.emotes.fetching){j="<em>Fetching emotes...</em>"}else{j="<em>Emotes loaded.</em>"}}l.item("Form",{ref:"switch",title:"Enable Emotes",text:'Here you can turn custom emotes on and off.\n\n<span class="emotestatus">'+j+"</span>",fields:[["Checkbox",{ref:"enabled",items:[{value:"yes",title:"On",selected:p.on}]}]],event:{change:function(q){b.emotes.on=(q.data.enabled.indexOf("yes")!=-1);if(b.emotes.on){b.emotes.fetch();return}if(b.emotes.fint===null){return}clearTimeout(b.emotes.fint);b.emotes.fint=null},save:function(q){p.on=b.emotes.on;b.save()},close:function(q){b.emotes.on=p.on;b.load();b.emotes.page=null}}})};a.ui.on("settings.open.ran",b.emotes.configure_page);b.emotes.fetch=function(){b.emotes.fetching=true;jQuery.getJSON("http://www.thezikes.org/publicemotes.php?format=jsonp&jsoncallback=?&"+(new Date()).getDay(),function(j){if(!b.emotes.loaded){if(b.emotes.on){b.emotes.notice=new Chatterbox.Popup(a.ui,{title:"Emotes",content:"Custom emoticons loaded!"});
b.emotes.notice.build();b.emotes.notice.window.css({bottom:60,right:50});setTimeout(function(){if(b.emotes.notice==null){return}b.emotes.notice.window.fadeOut("slow",function(){b.emotes.notice.window.remove();b.emotes.notice=null})},5000)}}b.emotes.fetching=false;b.emotes.loaded=true;b.emotes.emote=j;if(b.emotes.page!==null){b.emotes.page.view.find(".emotestatus").html("<em>Emotes loaded.</em>")}b.emotes.fint=setTimeout(b.emotes.fetch,3600000)});if(b.emotes.page!==null){b.emotes.page.view.find(".emotestatus").html("<em>Fetching emotes...</em>")}};b.emotes.swap=function(l){if(!b.emotes.on){return}var j=-1;for(var k in b.emotes.emote){if(!b.emotes.emote.hasOwnProperty(k)){continue}j=l.input.indexOf(k);if(j==-1){continue}l.input=replaceAll(l.input,k,":thumb"+b.emotes.emote[k]["devid"]+":")}l.input=replaceAll(l.input,":B",":bucktooth:")};a.bind("send.msg.before",b.emotes.swap);a.bind("send.action.before",b.emotes.swap);a.bind("send.kick.before",b.emotes.swap);a.bind("send.set.before",b.emotes.swap);
if(!b.emotes.on){return}b.emotes.fetch()};wsc.dAmn.Emotes.Picker=function(b,a){a=a||{};a=Object.extend({title:"Emotes",event:{submit:function(){},cancel:function(){}}},a);Chatterbox.Popup.ItemPicker.call(this,b,a);this.data=this.options["default"];this.add_page({ref:"a",href:"#a",label:"A",title:"Emotes beginning with A",items:[{value:"a",title:"a"},{value:"aa",title:"lol"},{value:"aaa",title:"fuck this"}]});this.add_page({ref:"b",href:"#b",label:"B",title:"Emotes beginning with B",items:["bitch"]})};wsc.dAmn.Emotes.Picker.prototype=new Chatterbox.Popup.ItemPicker();wsc.dAmn.Emotes.Picker.prototype.constructor=wsc.dAmn.Emotes.Picker;wsc.dAmn.Emotes.Picker.prototype.hide=function(){this.window.css({display:"none"})};wsc.dAmn.Emotes.Picker.prototype.show=function(){this.window.css({display:"block"})};wsc.dAmn.Emotes.Picker.prototype.close=function(){this.hide()};wsc.dAmn.Extension=function(a){a.settings.client="dAmnClient";a.settings.clientver="0.3";a.settings.domain="deviantart.com";a.settings.agent+=" wsc/dAmn/"+wsc.dAmn.VERSION;
