...
};Chatterbox.Settings.Item.prototype.resize=function(){for(var a in this.items){this.items[a].resize()}};Chatterbox.Settings.Item.prototype.hooks=function(f){if(!this.options.hasOwnProperty("event")){return}var b=this.options.event;var h=Chatterbox.template.settings.item.get(this.selector);if(h==false){return}if(!h.hasOwnProperty("events")){return}var g=[];for(var a in h.events){g=h.events[a];if(!b.hasOwnProperty(g[0])){continue}f.find(g[1]).bind(g[0],b[g[0]])}};Chatterbox.Settings.Item.prototype._event_stub=function(){};Chatterbox.Settings.Item.prototype._get_cb=function(a){if(!this.options.hasOwnProperty("event")){return this._event_stub}return this.options.event[a]||this._event_stub};Chatterbox.Settings.Item.prototype._get_ep=function(b){var g=Chatterbox.template.settings.item.get(this.selector);if(g==null){return false}if(!g.hasOwnProperty("events")){return false}var f=[];for(var a in g.events){f=g.events[a];if(f[0]==b){return f}}};Chatterbox.Settings.Item.prototype.save=function(g,h){var j=this._get_ep("inspect");
var b=j?this.view.find(j[1]):null;var a=this._get_cb("save");if(typeof a=="function"){a({input:b,item:this,page:h,window:g})}else{for(var f in a){var k=b.hasOwnProperty("slice")?b.slice(f,1):b;a[f]({input:k,item:this,page:h,window:g})}}for(var f in this.items){this.items[f].save(g,h)}};Chatterbox.Settings.Item.prototype.close=function(g,h){var j=this._get_ep("inspect");var b=j?this.view.find(j[1]):null;var a=this._get_cb("close");if(typeof a=="function"){a({input:b,item:this,page:h,window:g});return}for(var f in a){var k=b.hasOwnProperty("slice")?b.slice(f,1):b;a[f]({input:k,item:this,page:h,window:g})}for(var f in this.items){this.items[f].close(g,h)}};Chatterbox.Settings.Item.get=function(h,m,j,b,a){var g=h.split(".");var k=b||Chatterbox.Settings.Item;var l;for(var f in g){l=g[f];if(!k.hasOwnProperty(l)){k=a||Chatterbox.Settings.Item;break}k=k[l]}return new k(h,m,j)};Chatterbox.Settings.Item.Form=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.form=null;this.fields=[];this.lsection=null;
this.fsection=null;this.fieldo={}};Chatterbox.Settings.Item.Form.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.prototype.constructor=Chatterbox.Settings.Item.Form;Chatterbox.Settings.Item.Form.field=function(b,a){return Chatterbox.Settings.Item.get(b,a,this.manager,Chatterbox.Settings.Item.Form,Chatterbox.Settings.Item.Form.Field)};Chatterbox.Settings.Item.Form.prototype.build=function(h){Chatterbox.Settings.Item.prototype.build.call(this,h);if(this.view==null){return}this.lsection=this.view.find("section.labels");this.fsection=this.view.find("section.fields");if(!this.options.hasOwnProperty("fields")){return}var g;var j;for(var a in this.options.fields){g=this.options.fields[a];j=Chatterbox.Settings.Item.Form.field(g[0],g[1]);this.fields.push(j);j.build(this);if(g[1].hasOwnProperty("ref")){this.fieldo[g[1].ref]=j}}this.form=this.view.find("form");var b=this;this.form.bind("change",function(f){b.change()})};Chatterbox.Settings.Item.Form.prototype.resize=function(){for(var a in this.fields){this.fields[a].resize()
}};Chatterbox.Settings.Item.Form.prototype.change=function(){var f={};var g;for(var b in this.fields){g=this.fields[b];f[g.ref]=g.get()}var a=this._get_cb("change");if(typeof a=="function"){a({data:f,form:this})}else{for(var b in a){a[b]({data:f,form:this})}}};Chatterbox.Settings.Item.Form.prototype.save=function(g,j){var h={};var b;for(var f in this.fields){field=this.fields[f];h[field.ref]=field.get()}var a=this._get_cb("save");if(typeof a=="function"){a({data:h,form:this,page:j,window:g})}else{for(var f in a){a[f]({data:h,form:this,page:j,window:g})}}};Chatterbox.Settings.Item.Form.prototype.close=function(f,h){var g={};var j;for(var b in this.fields){j=this.fields[b];g[j.ref]=j.get()}var a=this._get_cb("close");if(typeof a=="function"){a({data:g,form:this,page:h,window:f})}else{for(var b in a){a[b]({data:g,form:this,page:h,window:f})}}};Chatterbox.Settings.Item.Form.Field=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.ref=this.options.ref||"ref";this.label=null;this.field=null;
