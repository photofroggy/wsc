...
};wsc.dAmn.BDS.Peer.Connection.prototype.set_local_stream=function(a){this.pc.addStream(a);this.stream=a;this.onlocalstream()};wsc.dAmn.BDS.Peer.Connection.prototype.persist=function(){var b=this;var a=this.call;b.onremotedescription=function(f){if(f!=0){return}b.create_answer()};b.onlocaldescription=function(f){switch(f){case 0:a.signal.offer(b);break;case 1:a.signal.answer(b);break;default:break}};b.onnegotiationneeded=function(){b.create_offer()}};wsc.dAmn.BDS.Peer.SignalChannel=function(f,a,h,g,b){this.user=f.settings.username;this.nse=ns?","+ns:"";this.bds=a;this.pns=h;this.ns=ns;this.app=g;this.app_ver=b;this.client=f};wsc.dAmn.BDS.Peer.SignalChannel.prototype.command=function(){var b=Array.prototype.slice.call(arguments);var g=b.shift();var a=this.pns;for(var f=0;f<b.length;f++){if(!b.hasOwnProperty(f)||!b[f]){continue}a+=","+b[f]}this.client.npmsg(this.bds,"BDS:PEER:"+g+":"+a)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.request=function(b,a){this.command("REQUEST",this.user,b||this.app,a||this.app_ver)
};wsc.dAmn.BDS.Peer.SignalChannel.prototype.ack=function(a,b){this.command("ACK",a,b,ver)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.accept=function(a,b){this.command("ACCEPT",a,b,ver)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.offer=function(a){this.command("OFFER",this.user,a.user,JSON.stringify(a.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.answer=function(a){this.command("ANSWER",this.user,a.user,JSON.stringify(a.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.candidate=function(b,a){this.command("CANDIDATE",this.user,b.user,JSON.stringify(a))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.reject=function(a,b){this.command("REJECT",a,b)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.close=function(a){this.command("CLOSE",(a||this.user))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.list=function(a){a=a?":"+a:"";this.client.npmsg(this.bds,"BDS:PEER:LIST"+a)};wsc.dAmn.BDS.Peer.SignalHandler=function(a){var b=this;a.bind("BDS.PEER.REQUEST",function(g,f){b.request(g,f)});a.bind("BDS.PEER.ACK",function(g,f){b.ack(g,f)
});a.bind("BDS.PEER.REJECT",function(g,f){b.reject(g,f)});a.bind("BDS.PEER.ACCEPT",function(g,f){b.accept(g,f)});a.bind("BDS.PEER.OPEN",function(g,f){b.open(g,f)});a.bind("BDS.PEER.END",function(g,f){b.end(g,f)});a.bind("BDS.PEER.OFFER",function(g,f){b.offer(g,f)});a.bind("BDS.PEER.ANSWER",function(g,f){b.answer(g,f)});a.bind("BDS.PEER.CANDIDATE",function(g,f){b.candidate(g,f)});a.bind("BDS.PEER.CLOSE",function(g,f){b.close(g,f)})};wsc.dAmn.BDS.Peer.SignalHandler.prototype.request=function(h,b){if(h.sns[0]!="@"){return}var k=h.param[0];var f=h.param[1];var l=h.param[2];var a=parseInt(h.param[3]);var g=b.bds.peer.call(k);if(!g){g=b.bds.peer.open(h.ns,k,f,l,a)}g.signal.ack(f,l);var j=g.peer(f);if(!j){j=g.new_peer(f)}b.trigger("peer.request",{name:"peer.request",ns:h.ns,call:g,user:f,app:l,version:a,peer:j});return true},wsc.dAmn.BDS.Peer.SignalHandler.prototype.ack=function(b,a){};wsc.dAmn.BDS.Peer.SignalHandler.prototype.reject=function(b,a){if(b.sns[0]!="@"){return}a.trigger("peer.reject",{name:"peer.reject",ns:b.ns,pns:b.param[0],user:b.param[1],reason:b.param[2]})
