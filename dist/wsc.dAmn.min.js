...
}T.connections.push(R)}P.cchannel.log_whois(T)};var z=function(Q,P){if(Q.ns.indexOf("login:")!=0){return}P.cchannel.server_message("Whois failed for "+(Q.sns.substr(1)),"not online")};var M=function(T,Q){var W=Q.channel(T.ns);var P=T.info.split("\n");var V="";var U=[];var R="";for(var S in P){if(!P.hasOwnProperty(S)){continue}V=P[S].split(" ");if(T.p=="privclass"){U.push([V.shift(),V.shift().split("=")[1],V.join(" ")])}else{if(T.p=="users"){R=V.shift().split(":",1)[0];U.push([R,W.get_privclass_order(R),V.join(" ")])}}}W.log_pc(T.p=="privclass",U)};E();wsc.defaults.Extension.Ignore(p);wsc.defaults.Extension.Away(p);wsc.defaults.Extension.Autojoin(p)};wsc.defaults.Extension.Autojoin=function(a){var g=a.autojoin;var j=function(){a.bind("cmd.autojoin",b);a.ui.on("settings.open",g.page)};g.page=function(p,r){var q=p.settings.page("Autojoin");var m="<ul>";var s={};s.ajon=a.autojoin.on;s.chan=a.autojoin.channel;if(a.autojoin.channel.length==0){m+="<li><i>No autojoin channels set</i></li></ul>"
}else{for(var l in a.autojoin.channel){if(!a.autojoin.channel.hasOwnProperty(l)){continue}m+="<li>"+a.autojoin.channel[l]+"</li>"}m+="</ul>"}q.item("Checkbox",{ref:"eaj",title:"Autojoin",text:"Turn on autojoin to automatically join selected channels                    when you connect to the chat server.",items:[{value:"yes",title:"On",selected:s.ajon}],event:{change:function(u){if(u.target.value=="yes"){a.autojoin.on=u.target.checked}},save:function(u){s.ajon=a.autojoin.on;a.config_save()},close:function(u){a.autojoin.on=s.ajon}}});var k=q.item("Items",{ref:"channelss",title:"Channels",text:"Add any channels you want to join automatically when you                    connect to the chat server.",items:a.autojoin.channel,prompt:{title:"Add Channel",label:"Channel:",},event:{up:function(u){var v=u.args.swap;a.autojoin.channel[v["this"].index]=v.that.item;a.autojoin.channel[v.that.index]=v["this"].item;k.options.items=a.autojoin.channel},down:function(u){var v=u.args.swap;a.autojoin.channel[v["this"].index]=v.that.item;
a.autojoin.channel[v.that.index]=v["this"].item;k.options.items=a.autojoin.channel},add:function(z){var v=a.deform_ns(z.args.item).toLowerCase();var u=a.autojoin.channel.indexOf(v);if(u!=-1){return}a.autojoin.channel.push(v);k.options.items=a.autojoin.channel},remove:function(u){a.autojoin.channel.splice(u.args.index,1);k.options.items=a.autojoin.channel},save:function(u){s.chan=a.autojoin.channel;a.config_save()},close:function(u){a.config_load()}}})};var b=function(s){var l=s.args.split(" ");if(!l){return}var q=l.shift().toLowerCase();var k=function(v){};var p=false;var u=a.channel(s.ns);switch(q){case"add":k=function(v){if(a.autojoin.channel.indexOf(v)==-1){p=true;a.autojoin.channel.push(v);u.server_message("Added "+v+" to your autojoin.")}else{u.server_message("Already have "+v+" on your autojoin.")}};break;case"rem":case"remove":k=function(z){var v=a.autojoin.channel.indexOf(z);if(v!=-1){p=true;a.autojoin.channel.splice(v,1);u.server_message("Removed "+z+" from your autojoin.")}else{u.server_message(z+" is not on your autojoin list.")
}};break;case"on":u.server_message("Autojoin on.");if(!a.autojoin.on){p=true;a.autojoin.on=true}break;case"off":u.server_message("Autojoin off.");if(a.autojoin.on){p=true;a.autojoin.on=false}break}var r="";for(var m in l){if(!l.hasOwnProperty(m)){continue}r=a.deform_ns(l[m]).toLowerCase();k(r)}if(p){a.config_save()}};j()};wsc.defaults.Extension.Away=function(b){var j=b.storage.folder("away");var g={on:false,reason:"",last:{},since:0,interval:60000,format:{setaway:"/me is away: {reason}",setback:"/me is back",away:"{user}: I've been away for {timesince}. Reason: {reason}"}};var q=function(){m();k();b.bind("cmd.setaway",a);b.bind("cmd.setback",p);b.bind("pkt.recv_msg.highlighted",l);b.ui.on("settings.open",g.page)};g.page=function(r,u){var s=r.settings.page("Away");var v={};v.away=g.format.away;v.sa=g.format.setaway;v.sb=g.format.setback;v.intr=g.interval;s.item("Text",{ref:"intro",title:"Away Messages",text:"Use away messages when you are away from the chats.\n\n                    You can set yourself away using the                     <code>/setaway [reason]</code> command. When you get back,                    use <code>/setback</code>. While you are away, the client                    will automatically respond when people try to talk to you,                    telling them you're away.",});
...
this.ci=this.mli;this.manager.resize();return this.ml}this.mli.css("display","none");this.input.css("display","inline-block");this.ci=this.input;this.manager.resize();return this.mli};Chatterbox.Control.prototype.add_button=function(g,a){a=Object.extend({label:"New",icon:false,href:"#button",title:"Button."},(a||{}));if(a.icon!==false){a.icon=" iconic "+a.icon}else{a.icon=""}this.brow.append(Chatterbox.render("control_button",a));var b=this.brow.find("a[href="+a.href+"].button");b.click(function(j){g();return false})};Chatterbox.Control.prototype._onkeypress=function(a){};Chatterbox.Control.prototype._onsubmit=function(a){};Chatterbox.Control.prototype.chomp=function(){d=this.ci.val();i=d.lastIndexOf(" ");if(i==-1){this.ci.val("");return d}chunk=d.slice(i+1);this.ci.val(d.slice(0,i));if(chunk.length==0){return this.chomp()}return chunk};Chatterbox.Control.prototype.unchomp=function(a){d=this.ci.val();if(!d){this.ci.val(a)}else{this.ci.val(d+" "+a)}};Chatterbox.Control.prototype.get_text=function(a){if(a==undefined){return this.ci.val()
...
this.value=[]};Chatterbox.Settings.Item.Form.Checkbox.prototype=new Chatterbox.Settings.Item.Form.Radio();Chatterbox.Settings.Item.Form.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Form.Checkbox;Chatterbox.Settings.Item.Form.Checkbox.prototype.build=function(g){g.lsection.append(Chatterbox.render("settings.item.form.label",{ref:this.ref,label:this.options.label||""}));this.label=g.lsection.find("label."+this.ref);this.lwrap=g.lsection.find("."+this.ref+".label");if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.ref;this.items[b.ref]=""}}g.fsection.append(Chatterbox.render("settings.item.form.field.wrap",{ref:this.ref,field:Chatterbox.render("settings.item.form.field.checkbox",this.options)}));this.fwrap=g.fsection.find("div."+this.ref+".field");this.field=this.fwrap.find("input:checkbox");var a=this;this.value=[];this.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())});this.field.bind("change",function(j){a.value=[];
a.fwrap.find("input[checked]:checkbox").each(function(){a.value.push(a.fwrap.find(this).val())})})};Chatterbox.Settings.Item.Form.Checkbox.prototype.resize=function(){this.lwrap.height(this.fwrap.find(".checkbox").height())};Chatterbox.Settings.Item.Radio=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.value=""};Chatterbox.Settings.Item.Radio.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Radio.prototype.constructor=Chatterbox.Settings.Item.Radio;Chatterbox.Settings.Item.Radio.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:radio");this.value=this.view.find("input[checked]:radio").val();var a=this;this.field.bind("change",function(j){a.value=a.view.find(this).val()})};Chatterbox.Settings.Item.Checkbox=function(b,a){Chatterbox.Settings.Item.Radio.call(this,b,a);this.value=[]
};Chatterbox.Settings.Item.Checkbox.prototype=new Chatterbox.Settings.Item.Radio();Chatterbox.Settings.Item.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Checkbox;Chatterbox.Settings.Item.Checkbox.prototype.build=function(g){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,g);this.field=this.view.find("input:checkbox");var a=this;this.value=[];this.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())});this.field.bind("change",function(j){a.value=[];a.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())})})};Chatterbox.Settings.Item.Items=function(b,a,g){a=Object.extend({prompt:{title:"Add Item",label:"Item:","submit-button":"Add"}},(a||{}));Chatterbox.Settings.Item.call(this,b,a,g);this.selected=false};Chatterbox.Settings.Item.Items.prototype=new Chatterbox.Settings.Item();
Chatterbox.Settings.Item.Items.prototype.constructor=Chatterbox.Settings.Item.Items;Chatterbox.Settings.Item.Items.prototype.build=function(b){Chatterbox.Settings.Item.prototype.build.call(this,b);var a=this;this.list=this.view.find("ul");this.buttons=this.view.find("section.buttons p");var g=this.list.find("li");g.click(function(k){var j=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=j.find(".item").html();j.addClass("selected")});g.each(function(j,l){var k=a.list.find(l);k.find("a.close").click(function(m){a.list.find("li.selected").removeClass("selected");a.selected=k.find(".item").html();k.addClass("selected");a.remove_item();return false})});this.buttons.find("a.button.up").click(function(j){a.shift_item(true);return false});this.buttons.find("a.button.down").click(function(j){a.shift_item();return false});this.buttons.find("a.button.add").click(function(j){var k=new Chatterbox.Popup.Prompt(a.manager,{position:[j.clientX-100,j.clientY-50],title:a.options.prompt.title,label:a.options.prompt.label,"submit-button":a.options.prompt["submit-button"],event:{submit:function(l){var p=l.data;
...
a[k]({input:m,item:this,args:j})}}};Chatterbox.Settings.Item.Items.prototype.save=function(){this._fevent("save",{items:this.options.items||[]})};Chatterbox.template={};Chatterbox.render=function(k,p){var j=Chatterbox.template;var g=k.split(".");var m={};var a=null;var b=null;for(var l in g){b=g[l];if(!j.hasOwnProperty(b)){return""}j=j[b]}if(j.hasOwnProperty("frame")){a=j;m=j.render||{};j=j.frame;if(a.hasOwnProperty("pre")){if(typeof a.pre=="function"){j=a.pre(j,p)}else{for(i in a.pre){j=a.pre[i](j,p)}}}}for(key in p){j=replaceAll(j,"{"+key+"}",(m[key]||Chatterbox.template.render_stub)(p[key]||""))}if(a!=null){if(a.hasOwnProperty("post")){if(typeof a.post=="function"){j=a.post(j,p)}else{for(i in a.post){j=a.post[i](j,p)}}}}return j};Chatterbox.template.render_stub=function(a){return a};Chatterbox.template.clean=function(a){return function(b,g){for(i in a){b=replaceAll(b,"{"+a[i]+"}","")}return b}};Chatterbox.template.ui='<nav class="tabs"><ul id="chattabs" class="tabs"></ul>        <ul id="tabnav">            <li><a href="#left" class="button iconic arrow_left"></a></li>            <li><a href="#right" class="button iconic arrow_right"></a></li>            <li><a href="#settings" title="Change client settings" class="button iconic cog" id="settings-button"></a></li>        </ul>        </nav>        <div class="chatbook"></div>';
