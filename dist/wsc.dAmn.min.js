...
a[g]({input:m,item:this,page:k,window:j})}}for(var g in this.items){this.items[g].save(j,k)}};Chatterbox.Settings.Item.prototype.close=function(j,k){var l=this._get_ep("inspect");var b=l?this.view.find(l[1]):null;var a=this._get_cb("close");if(typeof a=="function"){a({input:b,item:this,page:k,window:j});return}for(var g in a){var m=b.hasOwnProperty("slice")?b.slice(g,1):b;a[g]({input:m,item:this,page:k,window:j})}for(var g in this.items){this.items[g].close(j,k)}};Chatterbox.Settings.Item.get=function(k,q,l,b,a){var j=k.split(".");var m=b||Chatterbox.Settings.Item;var p;for(var g in j){p=j[g];if(!m.hasOwnProperty(p)){m=a||Chatterbox.Settings.Item;break}m=m[p]}console.log(k,m,a);return new m(k,q,l)};Chatterbox.Settings.Item.Form=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.form=null;this.fields=[];this.lsection=null;this.fsection=null;this.fieldo={}};Chatterbox.Settings.Item.Form.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.prototype.constructor=Chatterbox.Settings.Item.Form;
Chatterbox.Settings.Item.Form.field=function(b,a){return Chatterbox.Settings.Item.get(b,a,this.manager,Chatterbox.Settings.Item.Form,Chatterbox.Settings.Item.Form.Field)};Chatterbox.Settings.Item.Form.prototype.build=function(j){Chatterbox.Settings.Item.prototype.build.call(this,j);if(this.view==null){return}this.lsection=this.view.find("section.labels");this.fsection=this.view.find("section.fields");if(!this.options.hasOwnProperty("fields")){return}var g;var k;for(var a in this.options.fields){g=this.options.fields[a];console.log(g);k=Chatterbox.Settings.Item.Form.field(g[0],g[1]);this.fields.push(k);k.build(this);if(g[1].hasOwnProperty("ref")){this.fieldo[g[1].ref]=k}}this.form=this.view.find("form");var b=this;this.form.bind("change",function(l){b.change()})};Chatterbox.Settings.Item.Form.prototype.resize=function(){for(var a in this.fields){this.fields[a].resize()}};Chatterbox.Settings.Item.Form.prototype.change=function(){var g={};var j;for(var b in this.fields){j=this.fields[b];g[j.ref]=j.get()
}var a=this._get_cb("change");if(typeof a=="function"){a({data:g,form:this})}else{for(var b in a){a[b]({data:g,form:this})}}};Chatterbox.Settings.Item.Form.prototype.save=function(j,l){var k={};var b;for(var g in this.fields){field=this.fields[g];k[field.ref]=field.get()}var a=this._get_cb("save");if(typeof a=="function"){a({data:k,form:this,page:l,window:j})}else{for(var g in a){a[g]({data:k,form:this,page:l,window:j})}}};Chatterbox.Settings.Item.Form.prototype.close=function(g,k){var j={};var l;for(var b in this.fields){l=this.fields[b];j[l.ref]=l.get()}var a=this._get_cb("close");if(typeof a=="function"){a({data:j,form:this,page:k,window:g})}else{for(var b in a){a[b]({data:j,form:this,page:k,window:g})}}};Chatterbox.Settings.Item.Form.Field=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.ref=this.options.ref||"ref";this.label=null;this.field=null;this.value=""};Chatterbox.Settings.Item.Form.Field.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.Field.prototype.constructor=Chatterbox.Settings.Item.Form.Field;
