...
if(f.match(/.png$/i)){shadow=false}return dal+'><img class="thumb'+(shadow?" shadow":"")+'" width="'+tw+'" height="'+th+'" alt=":thumb'+id+':" src="'+path+'" /></a>'}],EOF:[0,"",null,"\x1b[m"]}};wsc.dAmn.TablumpParser.prototype.parse=function(b,a){return new wsc.dAmn.TablumpString(b,this)};wsc.dAmn.TablumpParser.prototype.tokenise=function(l){if(!l){return[]}var g="\t";var b=[];var k=-1;var a="";var m=null;for(var j=0;j<l.length;j++){if(l[j]!="&"){continue}b.push(["raw",l.substring(0,j)]);l=l.substring(j);j=0;k=l.indexOf("\t");if(k==-1){continue}a=l.substring(0,k+1);l=l.substring(k+1);m=this.crop(a,l);if(m===null){continue}j=-1;b.push(m[0]);l=m[1]}if(l.length>0){b.push(["raw",l])}return b};wsc.dAmn.TablumpParser.prototype.crop=function(b,a){var j=this.lumps[b];if(j===undefined){return null}if(j[0]==0){return[[b,[]],a]}else{var g=this.tokens(a,j[0]);return[[b,g[0]],g[1]]}};wsc.dAmn.TablumpParser.prototype.render=function(a,j){if(!j){return""}if(!j.hasOwnProperty("tokens")){return""}a=a+1;
var k="";var g=[];for(var b in j.tokens){if(!j.tokens.hasOwnProperty(b)){continue}g=j.tokens[b];if(g[0]=="raw"){k+=g[1];continue}k+=this.renderOne(a,g[0],g[1])}return k+this.renderOne(a,"EOF","")};wsc.dAmn.TablumpParser.prototype.renderOne=function(b,a,k){var g=this.lumps[a];if(g===undefined){return"&"+a+"\t"+k.join("\t")}var j=g[b]||g[1];if(typeof(j)=="string"){return String.format(j,k)}else{return j.call(this,k)}};wsc.dAmn.TablumpParser.prototype.tokens=function(b,a){var g=[];var j=-1;for(i=a;i>0;i--){j=b.indexOf("\t");if(j==-1){break}g.push(b.substring(0,j));b=b.substring(j+1);if(g[g.length-1]=="&"){g.pop();break}}return[g,b]};(function(a){a("*").hover(function(b){a(this).data("hover",true)},function(b){a(this).data("hover",false)});a.fn.wsc=function(g,b){client=a(window).data("wscclient");if(g=="init"||client===undefined){if(client==undefined){client=new wsc.Client(a(this),b,(a.browser.mozilla||false));a(window).resize(function(){client.ui.resize()});a(window).focus(function(){client.ui.control.focus()
