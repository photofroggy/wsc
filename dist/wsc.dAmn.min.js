...
}}o.ui.chatbook.each(r,true)};b.close=function(o){f.part(o.target);f.remove_ns(o.target)};b.whois=function(p,o){o.whois(p.args.split(" ")[0])};b.admin=function(p,o){o.admin(p.target,p.args)};b.disconnect=function(p,o){o.disconnect()};b.gett=function(p,o){var q=p.cmd.indexOf("title")>-1?"title":"topic";o.ui.control.set_text("/"+q+" "+o.channel(p.target).info[q].content)};var m=function(s,o){if(s.p!="info"){return}var q=s.pkt.sub;var u=q.shift().arg;u.username=s.sns.substr(1);u.connections=[];var r=null;var v={};while(q.length>0){v=q.shift();switch(v.cmd){case"conn":if(r!=null){u.connections.push(r)}r=v.arg;r.channels=[];break;case"agent":r.agent=[["agent",v.arg.agent]];if(v.arg.hasOwnProperty("url")){r.agent.push(["url",v.arg.url])}if(v.arg.hasOwnProperty("browser")){r.agent.push(["browser",v.arg.browser])}for(var p in v.arg){if(p=="agent"||p=="url"||p=="browser"){continue}if(v.arg.hasOwnProperty(p)){r.agent.push([p,v.arg[p]])}}break;case"ns":r.channels.unshift(o.deform_ns(v.param));break
}}u.connections.push(r);o.trigger("pkt.whois",{name:"pkt.whois",pkt:s.pkt,info:u})};var l=function(p,o){if(p.ns.indexOf("login:")!=0){return}var q=p.sns.substr(1);o.ui.pager.notice({ref:"whois-"+q,heading:"Whois Failed",content:"Whois failed for "+q+".\nNo such user online."},false,5000)};var g=function(s,p){var w=p.channel(s.ns);var o=s.info.split("\n");var v="";var u=[];var q="";for(var r in o){if(!o.hasOwnProperty(r)){continue}v=o[r].split(" ");if(s.p=="privclass"){u.push([v.shift(),v.shift().split("=")[1],v.join(" ")])}else{if(s.p=="users"){q=v.shift().split(":",1)[0];u.push([q,w.get_privclass_order(q),v.join(" ")])}}}p.ui.chatbook.current.log_pc(s.p=="privclass",u)};n();wsc.defaults.Extension.Ignore(f);wsc.defaults.Extension.Away(f);wsc.defaults.Extension.Autojoin(f)};wsc.defaults.Extension.Autojoin=function(a){var f=a.autojoin;var g=function(){a.bind("cmd.autojoin",b)};var b=function(o){var j=o.args.split(" ");if(!j){return}var m=j.shift().toLowerCase();var h=function(q){};var l=false;
var p=a.channel(o.ns);switch(m){case"add":h=function(q){if(a.autojoin.channel.indexOf(q)==-1){l=true;a.autojoin.channel.push(q)}else{}};break;case"rem":case"remove":h=function(r){var q=a.autojoin.channel.indexOf(r);if(q!=-1){l=true;a.autojoin.channel.splice(q,1)}else{}};break;case"on":if(!a.autojoin.on){l=true;a.autojoin.on=true}break;case"off":if(a.autojoin.on){l=true;a.autojoin.on=false}break;default:console.log("> start autojoin");console.log(a.autojoin);for(var k in a.autojoin.channel){if(!a.autojoin.channel.hasOwnProperty(k)){continue}a.join(a.autojoin.channel[k])}return;break}var n="";for(var k in j){if(!j.hasOwnProperty(k)){continue}n=a.deform_ns(j[k]).toLowerCase();h(n)}if(l){a.config_save()}};g()};wsc.defaults.Extension.Away=function(b){var g=b.storage.folder("away");var f={on:false,reason:"",last:{},since:0,interval:60000,format:{setaway:"/me is away: {reason}",setback:"/me is back",away:"{user}: I've been away for {timesince}. Reason: {reason}"}};b.away=f;var m=function(){k();
h();b.bind("cmd.setaway",a);b.bind("cmd.setback",l)};var a=function(p,n){f.on=true;f.last={};f.since=new Date();f.reason=p.args;var q=n.say;var o=replaceAll(f.format.setaway,"{reason}",f.reason||"[silent away]");if(o.indexOf("/me ")==0){o=o.substr(4);q=n.action}n.each_channel(function(r){q.call(n,r,o)})};var l=function(p,n){if(!f.on){return}f.on=false;var q=n.say;var o=f.format.setback;if(o.indexOf("/me ")==0){o=o.substr(4);q=n.action}n.each_channel(function(r){q.call(n,r,o)})};var j=function(q){if(!f.on){return}if(f.reason.length==0){return}if(q.user==b.settings.username){return}if(b.exclude.contains(q.ns)){return}var o=new Date();var p=q.sns.toLowerCase();if(p in f.last){if((o-f.last[p])<=f.interval){return}}var n=timeLengthString((o-f.since)/1000);var r=replaceAll(f.format.away,"{user}",q.user);r=replaceAll(r,"{timesince}",n);b.say(q.ns,replaceAll(r,"{reason}",f.reason));f.last[p]=o};var k=function(){f.format.setaway=g.get("setaway","/me is away: {reason}");f.format.setback=g.get("setback","/me is back");
f.format.away=g.get("away","{user}: I've been away for {timesince}. Reason: {reason}");f.interval=parseInt(g.get("interval",60000))};var h=function(){g.set("interval",f.interval);g.set("setaway",f.format.setaway);g.set("setback",f.format.setback);g.set("away",f.format.away)};m()};wsc.defaults.Extension.Ignore=function(f){var g={};var h=f.storage.folder("ignore");var a=h.folder("ignored");var m=function(){l();k();f.bind("cmd.ignore",b);f.bind("cmd.unignore",j)};var b=function(q){var s=q.args.split(" ");var n="";var r="";var p=false;for(var o in s){if(!s.hasOwnProperty(o)){continue}n=s[o];tmod=f.mute_user(n);if(!tmod){continue}p=tmod;r=replaceAll(g.ignore,"{user}",n);if(r.indexOf("/me ")==0){r=r.substr(4);f.action(q.target,r)}else{f.say(q.target,r)}}if(p){k()}};var j=function(r){var v=r.args.split(" ");var o="";var u="";var n=-1;var q=false;var s=false;for(var p in v){if(!v.hasOwnProperty(p)){continue}o=v[p];s=f.unmute_user(o);if(!s){continue}q=s;u=replaceAll(g.unignore,"{user}",o);if(u.indexOf("/me ")==0){u=u.substr(4);
f.action(r.target,u)}else{f.say(r.target,u)}}if(q){k()}};var l=function(){g.ignore=h.get("ignore","/me is ignoring {user} now");g.unignore=h.get("unignore","/me is not ignoring {user} anymore");g.count=parseInt(h.get("count",0));var o=null;if(g.count>0){o=null;for(var n=0;n<g.count;n++){}}};var k=function(){h.set("ignore",g.ignore);h.set("unignore",g.unignore);for(var n=0;n<g.count;n++){a.remove(n)}};m()};wsc.Client=function(b,f,g){this.mozilla=g;this.storage=new wsc.Storage;this.storage.ui=this.storage.folder("ui");this.storage.aj=this.storage.folder("autojoin");this.storage.aj.channel=this.storage.aj.folder("channel");this.fresh=true;this.attempts=0;this.connected=false;this.protocol=null;this.flow=null;this.ui=null;this.events=new EventEmitter();this.conn=null;this.channelo={};this.cchannel=null;this.cmds=[];this.settings={domain:"website.com",server:"ws://website.com/wsendpoint",symbol:"",username:"",userinfo:{},pk:"",monitor:["~Monitor",true],welcome:"Welcome to the wsc web client!",autojoin:"chat:channel",protocol:wsc.Protocol,mparser:wsc.MessageParser,flow:wsc.Flow,extend:[wsc.defaults.Extension],client:"chatclient",clientver:"0.3",developer:false};
...
}f.bds.channel.remove(n.ns)}};l()};wsc.dAmn.wsc.Colours=function(a,f,b){b.colours.send_colour=function(h,g){if(!b.colours.send){g(h);return}h.input+='<abbr title="colors:'+b.colours.user+":"+b.colours.msg+'"></abbr>';g(h)};a.middle("send.msg",b.colours.send_colour);a.middle("send.action",b.colours.send_colour)};wsc.dAmn.chatterbox.Colours=function(a,g,f){var b=a.ext.dAmn;f.colours.page=null;console.log(b);f.colours.configure_page=function(h,k){var j=h.settings.page("Colours");f.colours.page=j;var l={};l.on=b.colours.on;l.send=b.colours.send;l.msg=b.colours.msg;l.user=b.colours.user;j.item("Form",{ref:"switch",title:"Enable Chromacity Colours",text:"Here you can turn chromacity colours on and off.\n\nYou                    can choose to parse other people's colours, and send your                    own colours.",fields:[["Checkbox",{ref:"enabled",items:[{value:"parse",title:"Parse colours",selected:l.on},{value:"send",title:"Send colours",selected:l.send}]}]],event:{change:function(m){b.colours.on=(m.data.enabled.indexOf("parse")!=-1);
