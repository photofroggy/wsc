...
}l+="<li>"+a.autojoin.channel[k]+"</li>"}l+="</ul>"}p.item("Checkbox",{ref:"eaj",title:"Autojoin",text:"Turn on autojoin to automatically join selected channels                    when you connect to the chat server.",items:[{value:"yes",title:"On",selected:s.ajon}],event:{change:function(u){console.log(u,g);if(u.target.value=="yes"){a.autojoin.on=u.target.checked}},save:function(u){console.log(a.autojoin);s.ajon=a.autojoin.on;a.config_save()},close:function(u){a.autojoin.on=s.ajon}}});var r=p.item("Form",{ref:"channels",wclass:"boxed-ff-indv",title:"Channels",text:"Add any channels you want to join automatically when you                    connect to the chat server.",fields:[["Text",{ref:"channels",text:l}]],event:{change:function(u){},save:function(u){},close:function(u){a.config_save()}}})};var b=function(s){var l=s.args.split(" ");if(!l){return}var q=l.shift().toLowerCase();var k=function(v){};var p=false;var u=a.channel(s.ns);switch(q){case"add":k=function(v){if(a.autojoin.channel.indexOf(v)==-1){p=true;
