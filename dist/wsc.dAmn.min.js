...
b.save=function(){g.emotes.set("on",b.emotes.on);g.colours.set("on",b.colours.on);g.colours.set("send",b.colours.send);g.colours.set("msg",b.colours.msg);g.colours.set("user",b.colours.user)};b.load=function(){b.emotes.on=(g.emotes.get("on","false")=="true");b.colours.on=(g.colours.get("on","false")=="true");b.colours.send=(g.colours.get("send","false")=="true");b.colours.msg=g.colours.get("msg","");b.colours.user=g.colours.get("user","")};b.load();b.save();a.protocol.extend_maps({dAmnServer:["version"]});a.protocol.mparser=new wsc.dAmn.TablumpParser;a.flow.dAmnServer=a.flow.chatserver;a.exclude.add("chat:devart");a.exclude.add("chat:damnidlers");wsc.dAmn.BDS(a,g.bds,b);wsc.dAmn.BDS.Link(a,g.bds,b);wsc.dAmn.BDS.Peer(a,g.bds,b);wsc.dAmn.Emotes(a,g.emotes,b)};wsc.dAmn.avatar={};wsc.dAmn.avatar.ext=["gif","gif","jpg","png"];wsc.dAmn.avatar.link=function(a,b){var f=wsc.dAmn.avatar.src(a,b);return'<a target="_blank" title=":icon'+a+':" href="http://'+a+'.deviantart.com/"><img class="avatar"            alt=":icon'+a+':" src="'+f+'" height="50" /></a>'
