...
for(var a in b.pkt.sub){if(!b.pkt.sub.hasOwnProperty(a)){continue}this.register_user(b.pkt.sub[a])}this.set_user_list()};wsc.Channel.prototype.set_user_list=function(){if(Object.size(this.info.members)==0){return}var l=this.info.pc;var g=this.info.pc_order.slice(0);if("Room Members" in pcs){l[100]="Room Members";g.unshift("Room Members")}this.ui.build_user_list(l,g);var l=this.get_usernames();var b=[];var a=null;for(var j in l){if(!l.hasOwnProperty(j)){continue}var k=l[j];var h=this.info.members[k];var f=h.conn==1?"":"["+h.conn+"]";var m=h.symbol;this.ui.set_user({name:k,pc:h.pc,symbol:m,conn:h.conn,hover:{member:h,name:k,avatar:'<img class="avatar" src="" height="50" width="50" />',link:m+'<a target="_blank" href="http://'+k+"."+this.client.settings.domain+'/">'+k+"</a>",info:[]}})}this.client.trigger("set.userlist",{name:"set.userlist",ns:this.info.namespace})};wsc.Channel.prototype.register_user=function(a){var b=a.param;if(this.info.members[b]==undefined){this.info.members[b]=a.arg;
