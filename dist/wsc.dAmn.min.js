...
var g=this;var h=false;this.el.l.w.click(function(){if(!h){return}g.manager.control.focus()});this.el.l.w.mousedown(function(){h=true});this.el.l.w.mousemove(function(){h=false});this.el.t.l.click(function(){g.manager.toggle_channel(b);return false});this.el.t.c.click(function(j){g.manager.trigger("tab.close.clicked",{ns:g.raw,chan:g,e:j});return false});this.setup_header("title");this.setup_header("topic");if(this.hidden&&!this.manager.settings.developer){this.el.t.o.toggleClass("hidden")}this.manager.client.middle(this.namespace+".user.privchg",function(k,j){g.privchg(k,j)});this.built=true};Chatterbox.Channel.prototype.setup_header=function(a){var f=this;var b={};b.m=this.el.m.find("header."+a+" div");b.e=this.el.m.find("header."+a+" a[href=#edit]");b.t=this.el.m.find("header."+a+" textarea");b.s=this.el.m.find("header."+a+" a[href=#save]");b.c=this.el.m.find("header."+a+" a[href=#cancel]");this.el.h[a]=b.m;b.m.parent().mouseover(function(h){if(!b.editing){b.e.css("display","block");
return}b.s.css("display","block");b.c.css("display","block")});b.m.parent().mouseout(function(h){if(!b.editing){b.e.css("display","none");return}b.s.css("display","none");b.c.css("display","none")});b.e.click(function(h){b.t.text(f.manager.client.channel(f.namespace).info[a].content);b.t.css({display:"block",width:f.el.h[a].innerWidth()-10,});f.el.h[a].css("display","none");b.e.css("display","none");b.editing=true;f.resize();return false});var g=function(){var h=b.t.val();b.t.text("");b.t.css("display","none");f.el.h[a].css("display","block");b.s.css("display","none");b.c.css("display","none");b.editing=false;f.resize();return h};b.s.click(function(h){var j=g();f.manager.trigger(a+".save",{ns:f.raw,value:j});b.t.text("");return false});b.c.click(function(h){g();return false})};Chatterbox.Channel.prototype.hide=function(){this.el.m.css({display:"none"});this.el.t.o.removeClass("active");this.visible=false};Chatterbox.Channel.prototype.show=function(){this.visible=true;this.el.m.css({display:"block"});
...
var a=null;for(var b in this.items){if(!this.items.hasOwnProperty(b)){continue}f=this.items[b];a=g(b,f);if(a===false){break}}};Chatterbox.Settings.Page.prototype.save=function(b){for(var a in this.items){this.items[a].save(b,this)}};Chatterbox.Settings.Page.prototype.close=function(b){for(var a in this.items){this.items[a].close(b,this)}};Chatterbox.Settings.Item=function(b,a,f){this.manager=f||null;this.options=a||{};this.type=b||"base";this.selector=this.type.toLowerCase();this.items=[];this.itemo={};this.view=null;this.val=null;this._onchange=this._event_stub};Chatterbox.Settings.Item.prototype.build=function(k){if(!this.options.hasOwnProperty("ref")){return}var j=this.content();if(j.length==0){return}var a="";if(this.options.hasOwnProperty("wclass")){a=" "+this.options.wclass}var h=Chatterbox.render("settings.item.wrap",{type:this.type.toLowerCase().split(".").join("-"),ref:this.options.ref,"class":a});h=replaceAll(h,"{content}",j);k.append(h);this.view=k.find(".item."+this.options.ref);
this.hooks(this.view);if(!this.options.hasOwnProperty("subitems")){return}var l;var g;var f;var b;for(i in this.options.subitems){l=this.options.subitems[i];g=l[0];f=l[1];sitem=Chatterbox.Settings.Item.get(g,f);b=["stacked"];if(sitem.options.wclass){b.push(sitem.options.wclass)}sitem.options.wclass=b.join(" ");sitem.build(this.view);this.items.push(sitem);if(f.hasOwnProperty("ref")){this.itemo[f.ref]=sitem}}};Chatterbox.Settings.Item.prototype.content=function(){return Chatterbox.render("settings.item."+this.selector,this.options)};Chatterbox.Settings.Item.prototype.resize=function(){for(var a in this.items){this.items[a].resize()}};Chatterbox.Settings.Item.prototype.hooks=function(f){if(!this.options.hasOwnProperty("event")){return}var b=this.options.event;var h=Chatterbox.template.settings.item.get(this.selector);if(h==false){return}if(!h.hasOwnProperty("events")){return}var g=[];for(var a in h.events){g=h.events[a];if(!b.hasOwnProperty(g[0])){continue}f.find(g[1]).bind(g[0],b[g[0]])}};
Chatterbox.Settings.Item.prototype._event_stub=function(){};Chatterbox.Settings.Item.prototype._get_cb=function(a){if(!this.options.hasOwnProperty("event")){return this._event_stub}return this.options.event[a]||this._event_stub};Chatterbox.Settings.Item.prototype._get_ep=function(b){var g=Chatterbox.template.settings.item.get(this.selector);if(g==null){return false}if(!g.hasOwnProperty("events")){return false}var f=[];for(var a in g.events){f=g.events[a];if(f[0]==b){return f}}};Chatterbox.Settings.Item.prototype.save=function(g,h){var j=this._get_ep("inspect");var b=j?this.view.find(j[1]):null;var a=this._get_cb("save");if(typeof a=="function"){a({input:b,item:this,page:h,window:g})}else{for(var f in a){var k=b.hasOwnProperty("slice")?b.slice(f,1):b;a[f]({input:k,item:this,page:h,window:g})}}for(var f in this.items){this.items[f].save(g,h)}};Chatterbox.Settings.Item.prototype.close=function(g,h){var j=this._get_ep("inspect");var b=j?this.view.find(j[1]):null;var a=this._get_cb("close");
if(typeof a=="function"){a({input:b,item:this,page:h,window:g});return}for(var f in a){var k=b.hasOwnProperty("slice")?b.slice(f,1):b;a[f]({input:k,item:this,page:h,window:g})}for(var f in this.items){this.items[f].close(g,h)}};Chatterbox.Settings.Item.get=function(h,m,j,b,a){var g=h.split(".");var k=b||Chatterbox.Settings.Item;var l;for(var f in g){l=g[f];if(!k.hasOwnProperty(l)){k=a||Chatterbox.Settings.Item;break}k=k[l]}return new k(h,m,j)};Chatterbox.Settings.Item.Form=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.form=null;this.fields=[];this.lsection=null;this.fsection=null;this.fieldo={}};Chatterbox.Settings.Item.Form.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.prototype.constructor=Chatterbox.Settings.Item.Form;Chatterbox.Settings.Item.Form.field=function(b,a){return Chatterbox.Settings.Item.get(b,a,this.manager,Chatterbox.Settings.Item.Form,Chatterbox.Settings.Item.Form.Field)};Chatterbox.Settings.Item.Form.prototype.build=function(h){Chatterbox.Settings.Item.prototype.build.call(this,h);
if(this.view==null){return}this.lsection=this.view.find("section.labels");this.fsection=this.view.find("section.fields");if(!this.options.hasOwnProperty("fields")){return}var g;var j;for(var a in this.options.fields){g=this.options.fields[a];j=Chatterbox.Settings.Item.Form.field(g[0],g[1]);this.fields.push(j);j.build(this);if(g[1].hasOwnProperty("ref")){this.fieldo[g[1].ref]=j}}this.form=this.view.find("form");var b=this;this.form.bind("change",function(f){b.change()})};Chatterbox.Settings.Item.Form.prototype.resize=function(){for(var a in this.fields){this.fields[a].resize()}};Chatterbox.Settings.Item.Form.prototype.change=function(){var f={};var g;for(var b in this.fields){g=this.fields[b];f[g.ref]=g.get()}var a=this._get_cb("change");if(typeof a=="function"){a({data:f,form:this})}else{for(var b in a){a[b]({data:f,form:this})}}};Chatterbox.Settings.Item.Form.prototype.save=function(g,j){var h={};var b;for(var f in this.fields){field=this.fields[f];h[field.ref]=field.get()}var a=this._get_cb("save");
if(typeof a=="function"){a({data:h,form:this,page:j,window:g})}else{for(var f in a){a[f]({data:h,form:this,page:j,window:g})}}};Chatterbox.Settings.Item.Form.prototype.close=function(f,h){var g={};var j;for(var b in this.fields){j=this.fields[b];g[j.ref]=j.get()}var a=this._get_cb("close");if(typeof a=="function"){a({data:g,form:this,page:h,window:f})}else{for(var b in a){a[b]({data:g,form:this,page:h,window:f})}}};Chatterbox.Settings.Item.Form.Field=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.ref=this.options.ref||"ref";this.label=null;this.field=null;this.value=""};Chatterbox.Settings.Item.Form.Field.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.Field.prototype.constructor=Chatterbox.Settings.Item.Form.Field;Chatterbox.Settings.Item.Form.Field.prototype.build=function(a){a.lsection.append(Chatterbox.render("settings.item.form.label",{ref:this.ref,label:this.options.label||"","class":(this.options["class"]?" "+this.options["class"]:"")}));this.label=a.lsection.find("label."+this.ref);
