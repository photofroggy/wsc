...
Chatterbox.template.settings.item.form.field.text.pre=Chatterbox.template.settings.item.hint.prep;Chatterbox.template.settings.item.form.field.text.post=Chatterbox.template.clean(["title","text"]);Chatterbox.template.settings.item.form.field.text.render={title:Chatterbox.template.settings.krender.title,text:Chatterbox.template.settings.krender.text};Chatterbox.template.settings.item.form.field.text.frame="{title}<p>                                        {text}                                    </p>";wsc.dAmn={};wsc.dAmn.VERSION="0.3.10";wsc.dAmn.STATE="alpha";wsc.dAmn.Emotes=function(a,g,b){b.emotes.page=null;b.emotes.fint=null;b.emotes.notice=null;b.emotes.fetching=false;b.emotes.loaded=false;b.emotes.configure_page=function(k,m){var l=k.settings.page("Emotes");b.emotes.page=l;var p={};p.on=b.emotes.on;var j="";if(p.on){if(!b.emotes.loaded||b.emotes.fetching){j="<em>Fetching emotes...</em>"}else{j="<em>Emotes loaded.</em>"}}l.item("Form",{ref:"switch",title:"Enable Emotes",text:'Here you can turn custom emotes on and off.\n\n<span class="emotestatus">'+j+"</span>",fields:[["Checkbox",{ref:"enabled",items:[{value:"yes",title:"On",selected:p.on}]}]],event:{change:function(q){b.emotes.on=(q.data.enabled.indexOf("yes")!=-1);
