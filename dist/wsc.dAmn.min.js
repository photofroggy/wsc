...
};var h=function(q,p){var o=q.settings.page("About",true);o.item("Text",{ref:"about-wsc",title:"Wsc",text:'Currently using <a href="http://github.com/photofroggy/wsc/">wsc</a>                    version '+wsc.VERSION+" "+wsc.STATE+'.\n\nWsc                    works using HTML5, javascript, and CSS3. WebSocket is used for the connection                    where possible. The source code for this client is pretty huge.\n\nWsc was created                    by ~<a href="http://photofroggy.deviantart.com/">photofroggy</a>'})};var b={};b.theme=function(p,o){o.ui.theme(p.args.split(" ").shift())};b.setter=function(q){var p=q.args.split(" ");var o=p.shift().toLowerCase();var p=p.join(" ");if(p.length==0){f.cchannel.serverMessage("Could not set "+o,"No data supplied");return}if(!(o in f.settings)){f.cchannel.serverMessage('Unknown setting "'+o+'"');return}f.settings[o]=p;f.cchannel.serverMessage("Changed "+o+" setting","value: "+p);f.control.setLabel()};b.connection=function(o){f[o.cmd]()};b.join=function(o){var p=o.args.split(" ");
