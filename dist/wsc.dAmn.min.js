...
for(var f=0;f<b.length;f++){if(!b.hasOwnProperty(f)||!b[f]){continue}a+=","+b[f]}this.client.npmsg(this.bds,"BDS:PEER:"+g+":"+a)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.request=function(b,a){this.command("REQUEST",this.user,b||this.app,a||this.app_ver)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.ack=function(b,f,a){this.command("ACK",b,f||this.app,a||this.app_ver)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.accept=function(b,f,a){this.command("ACCEPT",b,f||this.app,a||this.app_ver)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.offer=function(a){this.command("OFFER",this.user,a.user,JSON.stringify(a.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.answer=function(a){this.command("ANSWER",this.user,a.user,JSON.stringify(a.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.candidate=function(b,a){this.command("CANDIDATE",this.user,b.user,JSON.stringify(a))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.reject=function(a,b){this.command("REJECT",a,b)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.close=function(a){this.command("CLOSE",(a||this.user))
