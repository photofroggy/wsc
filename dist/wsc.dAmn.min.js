...
Chatterbox.template.settings.item.form.field.colour={};Chatterbox.template.settings.item.form.field.colour.post=Chatterbox.template.clean(["ref","default"]);Chatterbox.template.settings.item.form.field.colour.frame='<input class="{ref}" type="color" value="{default}" />';wsc.dAmn={};wsc.dAmn.VERSION="0.9.22";wsc.dAmn.STATE="alpha";wsc.dAmn.BDS=function(f,l,g){var j={};var a={};g.bds={version:"0.4",mns:"chat:datashare",gate:"chat:dsgateway",channel:(new StringSet()),provides:["BOTCHECK","CLINK"]};f.bds=g.bds;g.bds.channel.add(g.bds.mns);g.bds.channel.add(g.bds.gate);var m=function(){f.hidden.add(g.bds.mns);f.exclude.add(g.bds.mns);f.hidden.add(g.bds.gate);f.exclude.add(g.bds.gate);f.bind("pkt.login",n);f.bind("pkt.recv_msg",b);f.bind("pkt.join",k.join);f.bind("BDS.BOTCHECK.DIRECT",k.botcheck);f.bind("BDS.BOTCHECK.ALL",k.botcheck);f.bind("BDS.BOTCHECK.OK",k.checkresp);f.bind("BDS.BOTCHECK.DENIED",k.checkresp);f.bind("CDS.LINK.REQUEST",k.clreq);f.bind("CDS.LINK.REJECT",k.clrj);f.bind("CDS.LINK.ACK",k.clra);
