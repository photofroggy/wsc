...
Chatterbox.template.settings.item.form.field.text.pre=Chatterbox.template.settings.item.hint.prep;Chatterbox.template.settings.item.form.field.text.post=Chatterbox.template.clean(["title","text"]);Chatterbox.template.settings.item.form.field.text.render={title:Chatterbox.template.settings.krender.title,text:Chatterbox.template.settings.krender.text};Chatterbox.template.settings.item.form.field.text.frame="{title}<p>                                        {text}                                    </p>";wsc.dAmn={};wsc.dAmn.VERSION="0.3.10";wsc.dAmn.STATE="alpha";wsc.dAmn.Emotes=function(a,g,b){b.emotes.emote={};b.emotes.map={};b.emotes.slist=[];b.emotes.page=null;b.emotes.fint=null;b.emotes.notice=null;b.emotes.fetching=false;b.emotes.loaded=false;b.emotes.picker=new wsc.dAmn.Emotes.Picker(a.ui);b.emotes.picker.build();b.emotes.picker.hide();a.ui.control.add_button({label:"",icon:"user",href:"#emotes",title:"Emote picker.",handler:function(){if(b.emotes.picker.window.css("display")=="none"){b.emotes.picker.show()
...
b.emotes.emote=j;if(!b.emotes.loaded){if(b.emotes.on){b.emotes.notice=new Chatterbox.Popup(a.ui,{title:"Emotes",content:"Custom emoticons loaded!"});b.emotes.notice.build();b.emotes.notice.window.css({bottom:60,right:50});setTimeout(function(){if(b.emotes.notice==null){return}b.emotes.notice.window.fadeOut("slow",function(){b.emotes.notice.window.remove();b.emotes.notice=null})},5000)}}b.emotes.sort();b.emotes.loaded=true;if(b.emotes.page!==null){b.emotes.page.view.find(".emotestatus").html("<em>Emotes loaded.</em>")}b.emotes.fint=setTimeout(b.emotes.fetch,3600000)});if(b.emotes.page!==null){b.emotes.page.view.find(".emotestatus").html("<em>Fetching emotes...</em>")}};b.emotes.swap=function(l){if(!b.emotes.on){return}var j=-1;for(var k in b.emotes.emote){if(!b.emotes.emote.hasOwnProperty(k)){continue}j=l.input.indexOf(k);if(j==-1){continue}l.input=replaceAll(l.input,k,":thumb"+b.emotes.emote[k]["devid"]+":")}l.input=replaceAll(l.input,":B",":bucktooth:")};b.emotes.sort=function(){var q=[[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],];
var p="ABCDEFGHIJKLMNOPQRSTUVWXYZ#";var r=null;var k=null;var j=false;var m=-1;for(var l in b.emotes.emote){if(!b.emotes.emote.hasOwnProperty(l)){continue}r=b.emotes.emote[l];k={value:r.code,title:"created by "+r.by};m=p.indexOf(r.code.substr(1,1).toUpperCase());if(m==-1){m=p.indexOf("#")}q[m].push(k)}var s=function(v,u){return caseInsensitiveSort(v.value,u.value)};for(var l=0;l<p.length;l++){if(!p.hasOwnProperty(l)){continue}q[l].sort(s);b.emotes.picker.page(p[l],b.emotes.picker.page("#")).options.items=q[l]}b.emotes.picker.refresh()};a.bind("send.msg.before",b.emotes.swap);a.bind("send.action.before",b.emotes.swap);a.bind("send.kick.before",b.emotes.swap);a.bind("send.set.before",b.emotes.swap);if(!b.emotes.on){return}b.emotes.fetch()};wsc.dAmn.Emotes.Picker=function(k,a){a=a||{};a=Object.extend({title:"Emotes",event:{submit:function(){},cancel:function(){}}},a);Chatterbox.Popup.ItemPicker.call(this,k,a);this.data=this.options["default"];var l="ABCDEFGHIJKLMNOP";var j="";var g="";for(var b=0;
b<l.length;b++){j=l[b];g=j.toLowerCase();this.add_page({ref:g,href:"#"+g,label:j,title:"Emotes beginning with "+j,items:[]})}this.add_page({ref:"misc",href:"#misc",label:"#",title:"Emotes not beginning with letters",items:[]})};wsc.dAmn.Emotes.Picker.prototype=new Chatterbox.Popup.ItemPicker();wsc.dAmn.Emotes.Picker.prototype.constructor=wsc.dAmn.Emotes.Picker;wsc.dAmn.Emotes.Picker.prototype.hide=function(){this.window.css({display:"none"})};wsc.dAmn.Emotes.Picker.prototype.show=function(){this.window.css({display:"block"})};wsc.dAmn.Emotes.Picker.prototype.close=function(){this.hide()};wsc.dAmn.Extension=function(a){a.settings.client="dAmnClient";a.settings.clientver="0.3";a.settings.domain="deviantart.com";a.settings.agent+=" wsc/dAmn/"+wsc.dAmn.VERSION;var g=a.storage.folder("dAmn");g.emotes=g.folder("emotes");var b={emotes:{on:false,emote:[]}};b.save=function(){g.emotes.set("on",b.emotes.on)};b.load=function(){b.emotes.on=(g.emotes.get("on","false")=="true")};b.load();b.save();a.protocol.extend_maps({dAmnServer:["version"]});
