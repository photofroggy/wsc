...
};wsc.Client.prototype.disconnect=function(){this.send(wsc_packetstr("disconnect"))};var Chatterbox={};Chatterbox.VERSION="0.19.102";Chatterbox.STATE="beta";Chatterbox.UI=function(b,a,f,h,g){this.client=b;this.events=g||new EventEmitter();this.mozilla=h;this.umuted=[];this.viewing=true;this.settings={themes:["wsct_dAmn","wsct_dark"],theme:"wsct_dark",monitor:["~Monitor",true],username:"",domain:"website.com",clock:true,tabclose:true,developer:false,media:"/static/"};var j=this;this.sound={bank:{m:null},add:function(k,l){if(j.sound.hasOwnProperty(k)){return false}j.sound.bank[k]=l;l.load();j.sound[k]=function(){j.sound.play(j.sound.bank[k])};return true},play:function(k){k.pause();k.currentTime=0;k.play()},toggle:function(l){for(var k in j.sound.bank){if(!j.sound.bank.hasOwnProperty(k)){continue}j.sound.bank[k].muted=l}},mute:function(){j.sound.toggle(true)},unmute:function(){j.sound.toggle(false)},};this.settings=a.extend(this.settings,f);a.append('<div class="wsc '+this.settings.theme+'"></div>');
this.mw=new wsc.Middleware();this.view=a.find(".wsc");this.mns=this.format_ns(this.settings.monitor[0]);this.lun=this.settings.username.toLowerCase();this.monitoro=null;this.swidth=(function(){if($.browser.msie){var m=$('<textarea cols="10" rows="2"></textarea>').css({position:"absolute",top:-1000,left:-1000}).appendTo("body"),l=$('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>').css({position:"absolute",top:-1000,left:-1000}).appendTo("body");scrollbarWidth=m.width()-l.width();m.add(l).remove()}else{var k=$("<div />").css({width:100,height:100,overflow:"auto",position:"absolute",top:-1000,left:-1000}).prependTo("body").append("<div />").find("div").css({width:"100%",height:200});scrollbarWidth=100-k.width();k.parent().remove()}return scrollbarWidth})();this.LIB="Chatterbox";this.VERSION=Chatterbox.VERSION;this.STATE=Chatterbox.STATE};wsc.defaults.UI=Chatterbox.UI;Chatterbox.UI.prototype.trigger=function(a,b){this.events.emit(a,b,this)};Chatterbox.UI.prototype.on=function(b,a){this.events.addListener(b,a)
...
Chatterbox.template.settings.item.form.field.colour={};Chatterbox.template.settings.item.form.field.colour.post=Chatterbox.template.clean(["ref","default"]);Chatterbox.template.settings.item.form.field.colour.frame='<input class="{ref}" type="color" value="{default}" />';wsc.dAmn.BDS.Peer=function(a,g,b){var f=function(){var h=new wsc.dAmn.BDS.Peer.SignalHandler(a)};b.bds.peer={handler:null,calls:{},call:function(h){h=h.toLowerCase();for(var j in b.bds.peer.calls){if(!b.bds.peer.calls.hasOwnProperty(j)){continue}if(j.toLowerCase()==h){return b.bds.peer.calls[j]}}return null},open:function(k,l,h,j,m){b.bds.peer.calls[l]=new wsc.dAmn.BDS.Peer.Call(a,k,l,h,j);return b.bds.peer.calls[l]},request:function(){},}};wsc.dAmn.BDS.Peer.bots=["botdom","damnphone"];wsc.dAmn.BDS.Peer.peer_options={iceServers:[{url:"stun:stun.l.google.com:19302"}]};wsc.dAmn.BDS.Peer.phone=null;wsc.dAmn.BDS.Peer.signal=null;wsc.dAmn.BDS.Peer.local={};wsc.dAmn.BDS.Peer.local.stream=null;wsc.dAmn.BDS.Peer.local.url=null;
wsc.dAmn.BDS.Peer.remote={};wsc.dAmn.BDS.Peer.remote._empty={video:null,audio:null,conn:null};wsc.dAmn.BDS.Peer.chan={};wsc.dAmn.BDS.Peer.chan.group=false;wsc.dAmn.BDS.Peer.chan.calls=[];wsc.dAmn.BDS.Peer.Call=function(f,a,l,g,j){this.client=f;this.bds=a;this.ns="";this.pns=l;this.user=g;this.app=j;this.title="";this.pc="";this.peers={};this.group=g.substr(0,5)=="chat:";var b=this.pns.split(":");var k=b.shift();if(k=="chat"){this.ns="chat:"+b.shift()}else{if(k=="pchat"){this.ns="pchat:"+b.shift()+":"+b.shift()}}if(b[0]=="pc"){b.shift();this.pc=b.shift()}this.title=b.join(":");this.group=wsc.dAmn.BDS.Peer.bots.indexOf(this.ns.substr(1))!=-1;this.signal=new wsc.dAmn.BDS.Peer.SignalChannel(f,a,l)};wsc.dAmn.BDS.Peer.Call.prototype.close=function(){for(var a in this.peers){if(!this.peers.hasOwnProperty(a)){continue}this.peers[a].conn.close()}};wsc.dAmn.BDS.Peer.Call.prototype.new_peer=function(a,b){var f=wsc.dAmn.BDS.peer_connection(this,a,b);this.peers[a]=f;return f};wsc.dAmn.BDS.Peer.Call.prototype.peer=function(a){return this.peers[a]||null
};wsc.dAmn.BDS.peer_connection=function(b,a,f){if(!wsc.dAmn.BDS.Peer.RTC.PeerConnection){return null}return new wsc.dAmn.BDS.Peer.Connection(b,a,f)};wsc.dAmn.BDS.Peer.Connection=function(b,a,f){this.call=b;this.user=a;this.pc=new wsc.dAmn.BDS.Peer.RTC.PeerConnection(wsc.dAmn.BDS.Peer._options);this.offer="";this.remote_offer=f||null;this.responding=this.remote_offer!=null;this.streamed=false;this.remote_stream=null;this.stream=null;this.bindings();if(this.remote_offer){this.set_remote_description(this.remote_offer)}};wsc.dAmn.BDS.Peer.Connection.prototype.bindings=function(){var b=this;var a=this.user;this.pc.onicecandidate=function(g){b.call.signal.candidate(b,g)};this.pc.onaddstream=function(g){b.set_remote_stream(g)};var f=function(){};this.onready=f;this.onopen=f;this.onremotestream=f;this.onlocalstream=f};wsc.dAmn.BDS.Peer.Connection.prototype.ready=function(a,g){this.onready=a||this.onready;this.remote_offer=g||this.remote_offer;this.responding=this.remote_offer!=null;if(this.responding){var f=this.onopen;
var b=this;this.onopen=function(){b.call.signal.answer(b);b.onopen=f};this.set_remote_description(this.remote_offer);return}this.create_offer()};wsc.dAmn.BDS.Peer.Connection.prototype.open=function(a,b){if(!this.offer){return}this.remote_offer=b||this.remote_offer;this.onopen=a||this.onopen;if(!this.remote_offer){return}this.set_remote_description(this.remote_offer)};wsc.dAmn.BDS.Peer.Connection.prototype.close=function(){this.pc.close()};wsc.dAmn.BDS.Peer.Connection.prototype.onerror=function(a){console.log(">> Got an error:",'"',a.message,'"',a)};wsc.dAmn.BDS.Peer.Connection.prototype.candidate=function(a){this.pc.addIceCandidate(a)};wsc.dAmn.BDS.Peer.Connection.prototype.create_offer=function(){var a=this;this.pc.createOffer(function(b){a.offer_created(b)},function(b){a.onerror(b)})};wsc.dAmn.BDS.Peer.Connection.prototype.offer_created=function(b){this.offer=b;var a=this;this.pc.setLocalDescription(this.offer,function(){a.local_description_set()},this.onerror)};wsc.dAmn.BDS.Peer.Connection.prototype.set_remote_description=function(b){this.remote_offer=b;
var a=this;this.pc.setRemoteDescription(this.remote_offer,function(){a.remote_description_set()},this.onerror)};wsc.dAmn.BDS.Peer.Connection.prototype.local_description_set=function(){this.onready()};wsc.dAmn.BDS.Peer.Connection.prototype.remote_description_set=function(){this.onopen()};wsc.dAmn.BDS.Peer.Connection.prototype.answer=function(){var a=this;this.responding=true;this.pc.createAnswer(function(b){a.answer_created(b)},function(b){a.onerror(b)})};wsc.dAmn.BDS.Peer.Connection.prototype.answer_created=function(b){this.offer=b;var a=this;this.pc.setLocalDescription(this.offer,function(){a.local_description_set()},function(f){a.onerror(f)})};wsc.dAmn.BDS.Peer.Connection.prototype.set_remote_stream=function(a){this.remote_stream=a.stream;this.onremotestream()};wsc.dAmn.BDS.Peer.Connection.prototype.set_local_stream=function(a){this.pc.addStream(a);this.stream=a;this.onlocalstream()};wsc.dAmn.BDS.Peer.SignalChannel=function(b,a,f){this.user=b.settings.username;this.nse=ns?","+ns:"";this.bds=this.bds;
this.pns=this.pns;this.ns=ns;this.client=b};wsc.dAmn.BDS.Peer.SignalChannel.prototype.command=function(){var b=Array.prototype.slice.call(arguments);var g=b.shift();var a=this.pns;for(var f=0;f<b.length;f++){if(!b[f]){continue}a+=","+b[f]}this.client.npmsg(this.bds,"BDS:PEER:"+g+":"+a)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.request=function(){this.command("REQUEST",this.user,"webcam")};wsc.dAmn.BDS.Peer.SignalChannel.prototype.accept=function(a){this.command("ACCEPT",a,this.nse)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.offer=function(a){this.command("OFFER",this.user,a.user,JSON.stringify(a.conn.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.answer=function(a){this.command("ANSWER",this.user,a.user,JSON.stringify(a.conn.offer))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.candidate=function(b,a){this.command("CANDIDATE",this.user,b.user,JSON.stringify(a))};wsc.dAmn.BDS.Peer.SignalChannel.prototype.reject=function(a,b){this.command("REJECT",a,b)};wsc.dAmn.BDS.Peer.SignalChannel.prototype.close=function(a){this.command("CLOSE",(a||this.user))
};wsc.dAmn.BDS.Peer.SignalChannel.prototype.list=function(a){a=a?":"+a:"";this.client.npmsg(this.bds,"BDS:PEER:LIST"+a)};wsc.dAmn.BDS.Peer.SignalHandler=function(a){var b=this;a.bind("BDS.PEER.REQUEST",function(g,f){b.request(g,f)});a.bind("BDS.PEER.ACK",function(g,f){b.ack(g,f)});a.bind("BDS.PEER.REJECT",function(g,f){b.reject(g,f)});a.bind("BDS.PEER.ACCEPT",function(g,f){b.accept(g,f)});a.bind("BDS.PEER.OPEN",function(g,f){b.open(g,f)});a.bind("BDS.PEER.END",function(g,f){b.end(g,f)});a.bind("BDS.PEER.OFFER",function(g,f){b.offer(g,f)});a.bind("BDS.PEER.ANSWER",function(g,f){b.answer(g,f)});a.bind("BDS.PEER.CANDIDATE",function(g,f){b.candidate(g,f)});a.bind("BDS.PEER.CLOSE",function(g,f){b.close(g,f)})};wsc.dAmn.BDS.Peer.SignalHandler.prototype.request=function(f,a){if(f.sns[0]!="@"){return}var g=f.param[0];var b=f.param[1];var h=f.param[2];a.npmsg(f.ns,"BDS:PEER:ACK:"+g+","+b);a.trigger("peer.request",{name:"peer.request",ns:f.ns,pns:g,user:b,app:h});return true},wsc.dAmn.BDS.Peer.SignalHandler.prototype.ack=function(b,a){};
wsc.dAmn.BDS.Peer.SignalHandler.prototype.reject=function(b,a){if(b.sns[0]!="@"){return}a.trigger("peer.reject",{name:"peer.reject",ns:b.ns,pns:b.param[0],user:b.param[1],reason:b.param[2]})};wsc.dAmn.BDS.Peer.SignalHandler.prototype.accept=function(g,a){if(g.sns[0]!="@"){return}var f=a.bds.peer.call(g.param[0]);if(!f){return}var b=g.param[1];var j=g.param[2];if(b.toLowerCase()!=a.settings.username.toLowerCase()){return}if(!f.group){var h=f.new_peer(g.user);if(!h){return}a.trigger("peer.new",{name:"peer.new",ns:g.ns,pns:f.pns,peer:h});h.ready(function(){f.signal.offer(h)})}a.trigger("peer.accept",{name:"peer.accept",ns:g.ns,pns:g.param[0],user:g.param[1],reason:g.param[2]})};wsc.dAmn.BDS.Peer.SignalHandler.prototype.open=function(b,a){};wsc.dAmn.BDS.Peer.SignalHandler.prototype.end=function(b,a){};wsc.dAmn.BDS.Peer.SignalHandler.prototype.offer=function(h,a){if(h.sns[0]!="@"){return}var f=a.bds.peer.call(h.param[0]);if(!f){return}var l=h.param[0];var b=h.param[1];var k=h.param[2];var g=new wsc.dAmn.BDS.Peer.RTC.SessionDescription(JSON.parse(h.param.slice(3).join(",")));
if(k.toLowerCase()!=a.settings.username.toLowerCase()){return}var j=f.peer(b);if(!j){if(!f.group){return}j=f.new_peer(b);a.trigger("peer.new",{name:"peer.new",ns:h.ns,pns:f.pns,peer:j})}j.ready(null,g)};wsc.dAmn.BDS.Peer.SignalHandler.prototype.answer=function(g,a){if(g.sns[0]!="@"){return}var b=a.bds.peer.call(g.param[0]);if(!b){return}var j=g.param[2];var f=new wsc.dAmn.BDS.Peer.RTC.SessionDescription(JSON.parse(g.param.slice(3).join(",")));if(j.toLowerCase()!=a.settings.username.toLowerCase()){return}var h=b.peer(user);if(!h){return}h.open(null,f)};wsc.dAmn.BDS.Peer.SignalHandler.prototype.candidate=function(g,a){if(g.sns[0]!="@"){return}var f=a.bds.peer.call(g.param[0]);if(!f){return}var j=g.param[2];var b=new wsc.dAmn.BDS.Peer.RTC.SessionDescription(JSON.parse(g.param.slice(3).join(",")));if(j.toLowerCase()!=a.settings.username.toLowerCase()){return}var h=f.peer(user);if(!h){return}h.candidate(b)};wsc.dAmn.BDS.Peer.SignalHandler.prototype.close=function(b,a){};wsc.dAmn.BDS.Peer.RTC={PeerConnection:null,SessionDescription:null,IceCandidate:null,};
wsc.dAmn.BDS.Peer._gum=function(){};wsc.dAmn.BDS.Peer.getUserMedia=function(b,f,a){return wsc.dAmn.BDS.Peer._gum(b,f,a)};if(window.mozRTCPeerConnection){wsc.dAmn.BDS.Peer.RTC.PeerConnection=mozRTCPeerConnection;wsc.dAmn.BDS.Peer.RTC.SessionDescription=mozRTCSessionDescription;wsc.dAmn.BDS.Peer.RTC.IceCandidate=mozRTCIceCandidate;wsc.dAmn.BDS.Peer._gum=function(b,f,a){return navigator.mozGetUserMedia(b,f,a)}}if(window.webkitRTCPeerConnection){wsc.dAmn.BDS.Peer.RTC.PeerConnection=webkitRTCPeerConnection;wsc.dAmn.BDS.Peer._gum=function(b,f,a){return navigator.webkitGetUserMedia(b,f,a)}}if(window.RTCPeerConnection){wsc.dAmn.BDS.Peer.RTC.PeerConnection=RTCPeerConnection;wsc.dAmn.BDS.Peer._gum=function(b,f,a){return navigator.getUserMedia(b,f,a)}}if(window.RTCSessionDescription){wsc.dAmn.BDS.Peer.RTC.SessionDescription=RTCSessionDescription;wsc.dAmn.BDS.Peer.RTC.IceCandidate=RTCIceCandidate}wsc.dAmn={};wsc.dAmn.VERSION="0.9.29";wsc.dAmn.STATE="alpha";wsc.dAmn.BDS=function(f,k,g){var h={};var a={};
g.bds={version:"0.4",mns:"chat:datashare",gate:"chat:dsgateway",channel:(new StringSet()),provides:["BOTCHECK","CLINK"]};f.bds=g.bds;g.bds.channel.add(g.bds.mns);g.bds.channel.add(g.bds.gate);var l=function(){f.hidden.add(g.bds.mns);f.exclude.add(g.bds.mns);f.hidden.add(g.bds.gate);f.exclude.add(g.bds.gate);f.bind("pkt.login",m);f.bind("pkt.recv_msg",b);f.bind("pkt.join",j.join);f.bind("BDS.BOTCHECK.DIRECT",j.botcheck);f.bind("BDS.BOTCHECK.ALL",j.botcheck);f.bind("BDS.BOTCHECK.OK",j.checkresp);f.bind("BDS.BOTCHECK.DENIED",j.checkresp);f.bind("CDS.LINK.REQUEST",j.clreq);f.bind("CDS.LINK.REJECT",j.clrj);f.bind("CDS.LINK.ACK",j.clra);f.bind("pkt.recv_join",j.pcrj);f.bind("pkt.recv_part",j.pcrp);f.bind("pkt.property",j.pcp);f.bind("closed",j.closed);f.ui.middle("log_item",function(o,n){j.filter(o,n)});f.middle("chan.recv_msg",function(o,n){j.hfilter(o,n)})};var m=function(n){if(n.pkt.arg.e!="ok"){return}f.join(g.bds.gate)};var b=function(q){if(q.user.toLowerCase()==f.settings.username.toLowerCase()){return
}if(!g.bds.channel.contains(q.ns)){return}var p={ns:q.ns,sns:q.sns,message:q.message,user:q.user,name:"",payload:"",head:[null,null,null],params:[]};var s=q.message.split(":");var o=[null,null,null];var r=null;for(var n in o){o[n]=s.shift()||null;if(o[n]==null){return}}r=s.join(":");p.name=o.join(".");p.payload=r;p.head=o;p.param=r.split(",");f.trigger(o[0],p);f.trigger(o[0]+"."+o[1],p);f.trigger(p.name,p)};var j={filter:function(o,n){if(f.settings.developer){n(o);return}if(o.ns[0]!="@"){n(o);return}var p=o.message.match(/<span class="cmsg u-([^"]+)">(.*)<\/span>/);if(!p){n(o);return}if(p[2].match(/^([A-Z0-9-_]+):([A-Z0-9-_]+):([A-Z0-9-_]+)(:.*|)$/)){return}n(o)},hfilter:function(o,n){if(f.settings.developer){n(o);return}if(o.sns[0]!="@"){n(o);return}if(o.message.match(/^([A-Z0-9-_]+):([A-Z0-9-_]+):([A-Z0-9-_]+)(:.*|)$/)){return}n(o)},closed:function(n){f.remove_ns(g.bds.mns);f.remove_ns(g.bds.gate)},join:function(n){if(n.ns.toLowerCase()!=g.bds.mns){return}if(n.pkt.arg.e!="ok"){return}},botcheck:function(o){if(o.head[2]!="ALL"&&o.payload!=f.settings.username){return
}if(o.ns.toLowerCase()==g.bds.gate&&f.channel(g.bds.mns)!=null){return}var n=wsc.VERSION+"/"+f.ui.VERSION+"/"+wsc.dAmn.VERSION+"/"+g.bds.version;var p=CryptoJS.MD5(("wsc.dAmn"+n+f.settings.username+o.user).toLowerCase());f.npmsg(o.ns,"BDS:BOTCHECK:CLIENT:"+o.user+",wsc.dAmn,"+n+","+p)},checkresp:function(n){if(n.ns.toLowerCase()!=g.bds.gate){return}if(n.param[0].toLowerCase()!=f.settings.username.toLowerCase()){return}if(f.channel(n.ns).info.members[f.settings.username].pc=="Visitors"){f.part(n.ns)}if(n.head[2]=="OK"){if(f.channel(g.bds.mns)==null){f.join(g.bds.mns)}return}f.ui.pager.notice({ref:"botcheckdenied",heading:"BDS Error",content:"Denied entry to backend channel.\nReason provided: <code>"+n.param.slice(1).join(",")+"</code>"})},clreq:function(r){if(r.payload.toLowerCase()!=f.settings.username.toLowerCase()){return}if(f.ui.umuted.indexOf(r.user.toLowerCase())!=-1){f.npmsg(r.ns,"CDS:LINK:REJECT:"+r.user+",You have been blocked");return}if(f.away.on){var p=new Date();var q=r.sns.toLowerCase();
var n=timeLengthString((p-f.away.since)/1000);var s=replaceAll(f.away.format.away,"{user}",r.user);s=replaceAll(s,"{timesince}",n);f.npmsg(r.ns,"CDS:LINK:REJECT:"+r.user+",Away; "+f.away.reason);return}f.npmsg(r.ns,"CDS:LINK:ACK:"+r.user);var o=f.ui.pager.notice({ref:"clink-"+r.user,icon:'<img src="'+wsc.dAmn.avatar.src(r.user,f.channel(r.ns).info.members[r.user].usericon)+'" />',heading:"Chat "+r.user,content:r.user+" wants to talk in private.\nType <code>/chat "+r.user+"</code> to talk to them, or use the buttons below.",buttons:{accept:{ref:"accept",target:"accept",label:"Accept",title:"Join the private chat",click:function(){f.ui.pager.remove_notice(o);f.join("@"+r.user);return false}},reject:{ref:"reject",target:"reject",label:"Reject",title:"Reject the private chat",click:function(){f.npmsg(r.ns,"CDS:LINK:REJECT:"+r.user);f.ui.pager.remove_notice(o);return false}}}},true);a[r.user]=o;o.onclose=function(){f.npmsg(r.ns,"CDS:LINK:REJECT:"+r.user)}},clrj:function(q){var n=q.user.toLowerCase();
var r=q.payload.split(",");var o=r.shift();r=r.join(",");if(o.toLowerCase()!=f.settings.username.toLowerCase()){return}if(!(n in h)){return}clearTimeout(h[n]);f.channel("@"+n).server_message("Chat request rejected",r)},clra:function(q){var n=q.user.toLowerCase();var r=q.payload.split(",");var o=r.shift();if(o.toLowerCase()!=f.settings.username.toLowerCase()){return}clearTimeout(h[n])},pcp:function(p){if(p.ns.indexOf("pchat")!=0){return}if(f.bds.channel.contains(p.ns)){return}if(p.pkt.arg.p!="members"){return}if(f.channel(p.ns).get_usernames().length==2){f.bds.channel.add(p.ns);return}var n=p.sns.substr(1);var o=p.ns;f.ui.channel(o).server_message(n+" has not yet joined","Sending them a notice...");f.npmsg("chat:datashare","CDS:LINK:REQUEST:"+n);h[n.toLowerCase()]=setTimeout(function(){try{f.ui.channel(o).server_message("Notification failed",n+" does not seem to be using a client that supports pchat notices.")}catch(q){}},10000)},pcrj:function(o){if(o.sns[0]!="@"){return}try{clearTimeout(h[o.user.toLowerCase()])
}catch(n){}f.bds.channel.add(o.ns);if(!(o.user in a)){return}f.ui.pager.remove_notice(a[o.user])},pcrp:function(n){if(n.sns[0]!="@"){return}f.bds.channel.remove(n.ns)}};l()};wsc.dAmn.Colours=function(a,f,b){b.colours.page=null;b.colours.configure_page=function(g,j){var h=g.settings.page("Colours");b.colours.page=h;var k={};k.on=b.colours.on;k.send=b.colours.send;k.msg=b.colours.msg;k.user=b.colours.user;h.item("Form",{ref:"switch",title:"Enable Chromacity Colours",text:"Here you can turn chromacity colours on and off.\n\nYou                    can choose to parse other people's colours, and send your                    own colours.",fields:[["Checkbox",{ref:"enabled",items:[{value:"parse",title:"Parse colours",selected:k.on},{value:"send",title:"Send colours",selected:k.send}]}]],event:{change:function(l){b.colours.on=(l.data.enabled.indexOf("parse")!=-1);b.colours.send=(l.data.enabled.indexOf("send")!=-1)},save:function(l){k.on=b.colours.on;k.send=b.colours.send},close:function(l){b.colours.on=k.on;
b.colours.send=k.send}}});h.item("Form",{ref:"colours",title:"Custom Colours",text:"Here you can set your own username colour and message colour.",fields:[["Colour",{ref:"usr",label:"Username Colour","default":"#"+k.user}],["Colour",{ref:"msg",label:"Message Colour","default":"#"+k.msg}]],event:{change:function(l){b.colours.user=l.data.usr.substr(1).toUpperCase();b.colours.msg=l.data.msg.substr(1).toUpperCase()},save:function(l){k.user=b.colours.user;k.msg=b.colours.msg},close:function(l){b.colours.user=k.user;b.colours.msg=k.msg},}})};b.colours.send_colour=function(h,g){if(!b.colours.send){g(h);return}h.input+='<abbr title="colors:'+b.colours.user+":"+b.colours.msg+'"></abbr>';g(h)};b.colours.parse_colour=function(j){if(!b.colours.on){return}var h=j.item.find("abbr");if(h.length==0){return}h=h.last();var g=h.prop("title").match(/colors:([A-F0-9]{6}):([A-F0-9]{6})/);if(g==null){return}h.remove();j.item.find(".cmsg, .caction").css("color","#"+g[2]);j.item.find(".cmsg.user, .caction.user").css("color","#"+g[1])
};a.ui.on("settings.open.ran",b.colours.configure_page);a.ui.on("log_item.after",b.colours.parse_colour);a.middle("send.msg",b.colours.send_colour);a.middle("send.action",b.colours.send_colour)};wsc.dAmn.Emotes=function(a,f,b){b.emotes.emote={};b.emotes.page=null;b.emotes.fint=null;b.emotes.notice=null;b.emotes.fetching=false;b.emotes.loaded=false;b.emotes.picker=new wsc.dAmn.Emotes.Picker(a.ui,{event:{select:function(g){b.emotes.select(g)},reload:function(){b.emotes.fetch()}}},b);b.emotes.picker.build();b.emotes.picker.hide();a.ui.control.add_button({label:"",icon:"user",href:"#emotes",title:"Emote picker.",handler:function(){if(b.emotes.picker.window.css("display")=="none"){b.emotes.picker.show()}else{b.emotes.picker.close()}}});b.emotes.configure_page=function(h,k){var j=h.settings.page("Emotes");b.emotes.page=j;var l={};l.on=b.emotes.on;var g="";if(l.on){if(!b.emotes.loaded||b.emotes.fetching){g="<em>Fetching emotes...</em>"}else{g="<em>Emotes loaded.</em>"}}j.item("Form",{ref:"switch",title:"Enable Emotes",text:"Here you can turn custom emotes on and off.",fields:[["Checkbox",{ref:"enabled",items:[{value:"yes",title:"On",selected:l.on}]}]],event:{change:function(m){b.emotes.on=(m.data.enabled.indexOf("yes")!=-1);
