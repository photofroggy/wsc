...
},clra:function(q){var n=q.user.toLowerCase();var r=q.payload.split(",");var o=r.shift();if(o.toLowerCase()!=f.settings.username.toLowerCase()){return}clearTimeout(h[n])},pcp:function(p){if(p.ns.indexOf("pchat")!=0){return}if(f.bds.channel.contains(p.ns)){return}if(p.pkt.arg.p!="members"){return}if(f.channel(p.ns).get_usernames().length==2){f.bds.channel.add(p.ns);return}var n=p.sns.substr(1);var o=p.ns;f.channel(o).server_message(n+" has not yet joined","Sending them a notice...");f.npmsg("chat:datashare","CDS:LINK:REQUEST:"+n);h[n.toLowerCase()]=setTimeout(function(){try{f.channel(o).server_message("Notification failed",n+" does not seem to be using a client that supports pchat notices.")}catch(q){}},10000)},pcrj:function(o){if(o.sns[0]!="@"){return}try{clearTimeout(h[o.user.toLowerCase()])}catch(n){}f.bds.channel.add(o.ns);if(!(o.user in a)){return}f.ui.pager.remove_notice(a[o.user])},pcrp:function(n){if(n.sns[0]!="@"){return}f.bds.channel.remove(n.ns)}};l()};wsc.dAmn.Colours=function(a,f,b){b.colours.page=null;
b.colours.configure_page=function(g,j){var h=g.settings.page("Colours");b.colours.page=h;var k={};k.on=b.colours.on;k.send=b.colours.send;k.msg=b.colours.msg;k.user=b.colours.user;h.item("Form",{ref:"switch",title:"Enable Chromacity Colours",text:"Here you can turn chromacity colours on and off.\n\nYou                    can choose to parse other people's colours, and send your                    own colours.",fields:[["Checkbox",{ref:"enabled",items:[{value:"parse",title:"Parse colours",selected:k.on},{value:"send",title:"Send colours",selected:k.send}]}]],event:{change:function(l){b.colours.on=(l.data.enabled.indexOf("parse")!=-1);b.colours.send=(l.data.enabled.indexOf("send")!=-1)},save:function(l){k.on=b.colours.on;k.send=b.colours.send},close:function(l){b.colours.on=k.on;b.colours.send=k.send}}});h.item("Form",{ref:"colours",title:"Custom Colours",text:"Here you can set your own username colour and message colour.",fields:[["Colour",{ref:"usr",label:"Username Colour","default":"#"+k.user}],["Colour",{ref:"msg",label:"Message Colour","default":"#"+k.msg}]],event:{change:function(l){b.colours.user=l.data.usr.substr(1).toUpperCase();
