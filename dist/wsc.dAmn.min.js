...
p.ui.on("settings.open.ran",L);p.ui.on("settings.save",H)};var H=function(S,R){console.log(S);p.settings.ui.theme=S.theme;p.settings.ui.clock=S.clock;p.settings.ui.tabclose=S.tabclose;p.config_save()};var q=function(T,S){var R=T.settings.page("Main",true);var U={};U.username=p.settings.username;U.pk=p.settings.pk;R.item("Form",{ref:"login",title:"Login",text:"Here you can change the username and token used to                    log into the chat server.",fields:[["Textfield",{ref:"username",label:"Username","default":U.username}],["Textfield",{ref:"token",label:"Token","default":U.pk}]],event:{save:function(V){p.settings.username=V.data.username;p.settings.pk=V.data.token}}},true);R.item("Text",{ref:"intro",title:"Main",text:"Use this window to view and change your settings.\n\nCheck                    the different pages to see what settings can be changed.",},true);R.item("Text",{ref:"debug",wclass:"faint",title:"Debug Information",text:"Chat Agent: <code>"+p.settings.agent+"</code>\n\nUser                    Agent: <code>"+navigator.userAgent+"</code>"})
