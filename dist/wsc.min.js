...
}l+="<li>"+a.autojoin.channel[k]+"</li>"}l+="</ul>"}p.item("Checkbox",{ref:"eaj",title:"Autojoin",text:"Turn on autojoin to automatically join selected channels                    when you connect to the chat server.",items:[{value:"yes",title:"On",selected:s.ajon}],event:{change:function(t){console.log(t,g);if(t.target.value=="yes"){a.autojoin.on=t.target.checked}},save:function(t){console.log(a.autojoin);s.ajon=a.autojoin.on;a.config_save()},close:function(t){a.autojoin.on=s.ajon}}});var r=p.item("Form",{ref:"autojoin",wclass:"boxed-ff-indv",title:"Autojoin",text:"Add any channels you want to join automatically when you                    connect to the chat server.",fields:[["Text",{ref:"channels",text:l}]],event:{change:function(t){},save:function(t){},close:function(t){a.config_save()}}})};var b=function(s){var l=s.args.split(" ");if(!l){return}var q=l.shift().toLowerCase();var k=function(u){};var p=false;var t=a.channel(s.ns);switch(q){case"add":k=function(u){if(a.autojoin.channel.indexOf(u)==-1){p=true;
...
b=b.slice(1);bits=b.split(" ");cmdn=bits.shift().toLowerCase();ens=this.client.cchannel.namespace;etarget=ens;if(bits[0]){hash=bits[0][0];if((hash=="#"||hash=="@")&&bits[0].length>1){etarget=this.client.format_ns(bits.shift())}}arg=bits.join(" ");this.client.trigger("cmd."+cmdn,{name:"cmd",cmd:cmdn,args:arg,target:etarget,ns:ens})};var Chatterbox={};Chatterbox.VERSION="0.6.49";Chatterbox.STATE="beta";Chatterbox.UI=function(a,b,j,g){this.events=g||new EventEmitter();this.mozilla=j;this.umuted=[];this.settings={themes:["wsct_default","wsct_dAmn"],theme:"wsct_default",monitor:["~Monitor",true],username:"",domain:"website.com",clock:true,tabclose:true};a.extend(this.settings,b);a.append('<div class="wsc '+this.settings.theme+'"></div>');this.view=a.find(".wsc");this.mns=this.format_ns(this.settings.monitor[0]);this.lun=this.settings.username.toLowerCase();this.monitoro=null;this.swidth=(function(){if($.browser.msie){var m=$('<textarea cols="10" rows="2"></textarea>').css({position:"absolute",top:-1000,left:-1000}).appendTo("body"),l=$('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>').css({position:"absolute",top:-1000,left:-1000}).appendTo("body");
