...
for(var a in b.pkt.sub){if(!b.pkt.sub.hasOwnProperty(a)){continue}this.register_user(b.pkt.sub[a])}this.set_user_list()};wsc.Channel.prototype.set_user_list=function(){if(Object.size(this.info.members)==0){return}var k=this.info.pc;var f=this.info.pc_order.slice(0);if("Room Members" in pcs){k[100]="Room Members";f.unshift("Room Members")}this.ui.build_user_list(k,f);var k=this.get_usernames();var b=[];var a=null;for(var h in k){if(!k.hasOwnProperty(h)){continue}var j=k[h];var g=this.info.members[j];var d=g.conn==1?"":"["+g.conn+"]";var l=g.symbol;this.ui.set_user({name:j,pc:g.pc,symbol:l,conn:g.conn,hover:{member:g,name:j,avatar:'<img class="avatar" src="" height="50" width="50" />',link:l+'<a target="_blank" href="http://'+j+"."+this.client.settings.domain+'/">'+j+"</a>",info:[]}})}this.client.trigger("set.userlist",{name:"set.userlist",ns:this.info.namespace})};wsc.Channel.prototype.register_user=function(a){var b=a.param;if(this.info.members[b]==undefined){this.info.members[b]=a.arg;
