...
};wsc.Flow.prototype.recv_action=wsc.Flow.prototype.recv_msg;wsc.Flow.prototype.recv_npmsg=wsc.Flow.prototype.recv_msg;wsc.Flow.prototype.recv_privchg=function(b,a){a.channel(b.ns).recv_privchg(b)};wsc.Flow.prototype.recv_kicked=function(b,a){a.channel(b.ns).recv_kicked(b)};wsc.defaults.Extension=function(d){var a={};a.away={on:false,reason:"",last:{},since:0,store:d.storage.folder("away"),format:{setaway:"/me is away: {reason}",setback:"/me is back",away:"{from}: I am away, reason: {reason}"}};var m=function(){d.bind("cmd.connect",b.connection);d.bind("cmd.set",b.setter);d.bind("cmd.join",b.join);d.bind("cmd.chat",b.pjoin);d.bind("cmd.part",b.part);d.bind("cmd.say",b.say);d.bind("cmd.npmsg",b.npmsg);d.bind("cmd.me",b.action);d.bind("cmd.promote",b.chgpriv);d.bind("cmd.demote",b.chgpriv);d.bind("cmd.ban",b.ban);d.bind("cmd.unban",b.ban);d.bind("cmd.kick",b.killk);d.bind("cmd.whois",b.whois);d.bind("cmd.title",b.title);d.bind("cmd.topic",b.title);d.bind("cmd.admin",b.admin);d.bind("cmd.disconnect",b.connection);
d.bind("cmd.kill",b.killk);d.bind("cmd.raw",b.raw);d.bind("cmd.clear",b.clear);d.bind("cmd.clearall",b.clearall);d.bind("cmd.close",b.close);d.bind("pkt.property",l);d.bind("pkt.recv_admin_show",f);d.bind("pkt.recv_admin_showverbose",f);d.bind("pkt.get",k);d.bind("cmd.gettitle",b.gett);d.bind("cmd.gettopic",b.gett);d.bind("cmd.theme",b.theme)};var j=function(o,n){d.settings.ui.theme=o.theme;d.settings.ui.clock=o.clock;d.settings.ui.tabclose=o.tabclose};var h=function(p,o){var n=p.settings.page("Main");var q={};q.username=d.settings.username;q.pk=d.settings.pk;q.devel=d.settings.developer;n.item("Form",{ref:"login",title:"Login",text:"Here you can change the username and token used to                    log into the chat server.",fields:[["Textfield",{ref:"username",label:"Username","default":q.username}],["Textfield",{ref:"token",label:"Token","default":q.pk}]],event:{save:function(r){d.settings.username=r.data.username;d.settings.pk=r.data.token}}},true);n.item("Form",{ref:"developer",title:"Developer Mode",text:"Turn developer mode on or off.\n\nDeveloper mode will expose any hidden                channel tabs, amongst other things. Keep this turned off unless you're working                on implementing something.",fields:[["Checkbox",{ref:"enabled",items:[{value:"on",title:"On",selected:q.devel}]}]],event:{change:function(r){d.settings.developer=(r.data.enabled.indexOf("on")!=-1);
