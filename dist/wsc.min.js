...
Chatterbox.template.feed='<div class="window feed" id="{selector}-window">                    <div class="log" id="{selector}-log">                        <header class="info">                            <div class="info">                                <h3>{name}<span>{meta}</span></h3>                                <p>{info}</p>                                <ul>                                    <li><a href="#refresh" class="button iconic spin" title="Refresh the feed"></a></li>                                    <li><a href="#post" class="button iconic check" title="Post to this feed"></a></li>                                    <li><a href="#close" class="button iconic x" title="Close this feed"></a></li>                                </ul>                            </div>                        </header>                        <ul class="logwrap"></ul>                    </div>                    <div class="users" id="{selector}-users">                </div>            </div>';
Chatterbox.template.feedmsg='<li id="{ref}">                                <article>                                    <a href="#close" class="iconic x" title="Remove feed message"></a>                                    <section class="label">{icon}</section>                                    <section class="content">                                        <h3>{title}</h3>                                        {content}                                    </section>                                </article>                            </li>';Chatterbox.template.channel='<div class="window" id="{selector}-window">                    <header class="title">                        <div class="title"></div>                        <textarea></textarea>                        <a href="#edit" class="button iconic pen" title="Edit the title"></a>                        <a href="#save" class="button iconic check" title="Save changes"></a>                        <a href="#cancel" class="button iconic x" title="Cancel"></a>                    </header>                    <div class="log" id="{selector}-log">                        <header class="topic">                            <div class="topic"></div>                            <textarea></textarea>                            <a href="#edit" class="button iconic pen" title="Edit the topic"></a>                            <a href="#save" class="button iconic check" title="Save changes"></a>                            <a href="#cancel" class="button iconic x" title="Cancel"></a>                        </header>                        <ul class="logwrap"></ul>                    </div>                    <div class="users" id="{selector}-users">                </div>            </div>';
