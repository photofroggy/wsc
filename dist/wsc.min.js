...
}}n.ui.chatbook.each(q,true)};b.close=function(n){d.part(n.target);d.remove_ns(n.target)};b.whois=function(o,n){n.whois(o.args.split(" ")[0])};b.admin=function(o,n){n.admin(o.target,o.args)};b.disconnect=function(o,n){n.disconnect()};b.gett=function(o,n){var p=o.cmd.indexOf("title")>-1?"title":"topic";n.ui.control.set_text("/"+p+" "+n.channel(o.target).info[p].content)};var l=function(r,n){if(r.p!="info"){return}var p=r.pkt.sub;var s=p.shift().arg;s.username=r.sns.substr(1);s.connections=[];var q=null;var t={};while(p.length>0){t=p.shift();switch(t.cmd){case"conn":if(q!=null){s.connections.push(q)}q=t.arg;q.channels=[];break;case"agent":q.agent=[["agent",t.arg.agent]];if(t.arg.hasOwnProperty("url")){q.agent.push(["url",t.arg.url])}if(t.arg.hasOwnProperty("browser")){q.agent.push(["browser",t.arg.browser])}for(var o in t.arg){if(o=="agent"||o=="url"||o=="browser"){continue}if(t.arg.hasOwnProperty(o)){q.agent.push([o,t.arg[o]])}}break;case"ns":q.channels.unshift(n.deform_ns(t.param));break
}}s.connections.push(q);n.trigger("pkt.whois",{name:"pkt.whois",pkt:r.pkt,info:s})};var k=function(o,n){if(o.ns.indexOf("login:")!=0){return}var p=o.sns.substr(1);n.ui.pager.notice({ref:"whois-"+p,heading:"Whois Failed",content:"Whois failed for "+p+".\nNo such user online."},false,5000)};var f=function(r,o){var u=o.channel(r.ns);var n=r.info.split("\n");var t="";var s=[];var p="";for(var q in n){if(!n.hasOwnProperty(q)){continue}t=n[q].split(" ");if(r.p=="privclass"){s.push([t.shift(),t.shift().split("=")[1],t.join(" ")])}else{if(r.p=="users"){p=t.shift().split(":",1)[0];s.push([p,u.get_privclass_order(p),t.join(" ")])}}}o.ui.chatbook.current.log_pc(r.p=="privclass",s)};m();wsc.defaults.Extension.Ignore(d);wsc.defaults.Extension.Away(d);wsc.defaults.Extension.Autojoin(d)};wsc.defaults.Extension.Autojoin=function(a){var d=a.autojoin;var f=function(){a.bind("cmd.autojoin",b)};var b=function(n){var h=n.args.split(" ");if(!h){return}var l=h.shift().toLowerCase();var g=function(p){};var k=false;
var o=a.channel(n.ns);switch(l){case"add":g=function(p){if(a.autojoin.channel.indexOf(p)==-1){k=true;a.autojoin.channel.push(p)}else{}};break;case"rem":case"remove":g=function(q){var p=a.autojoin.channel.indexOf(q);if(p!=-1){k=true;a.autojoin.channel.splice(p,1)}else{}};break;case"on":if(!a.autojoin.on){k=true;a.autojoin.on=true}break;case"off":if(a.autojoin.on){k=true;a.autojoin.on=false}break;default:console.log("> start autojoin");console.log(a.autojoin);for(var j in a.autojoin.channel){if(!a.autojoin.channel.hasOwnProperty(j)){continue}a.join(a.autojoin.channel[j])}return;break}var m="";for(var j in h){if(!h.hasOwnProperty(j)){continue}m=a.deform_ns(h[j]).toLowerCase();g(m)}if(k){a.config_save()}};f()};wsc.defaults.Extension.Away=function(b){var f=b.storage.folder("away");var d={on:false,reason:"",last:{},since:0,interval:60000,format:{setaway:"/me is away: {reason}",setback:"/me is back",away:"{user}: I've been away for {timesince}. Reason: {reason}"}};b.away=d;var l=function(){j();
g();b.bind("cmd.setaway",a);b.bind("cmd.setback",k)};var a=function(o,m){d.on=true;d.last={};d.since=new Date();d.reason=o.args;var p=m.say;var n=replaceAll(d.format.setaway,"{reason}",d.reason||"[silent away]");if(n.indexOf("/me ")==0){n=n.substr(4);p=m.action}m.each_channel(function(q){p.call(m,q,n)})};var k=function(o,m){if(!d.on){return}d.on=false;var p=m.say;var n=d.format.setback;if(n.indexOf("/me ")==0){n=n.substr(4);p=m.action}m.each_channel(function(q){p.call(m,q,n)})};var h=function(p){if(!d.on){return}if(d.reason.length==0){return}if(p.user==b.settings.username){return}if(b.exclude.contains(p.ns)){return}var n=new Date();var o=p.sns.toLowerCase();if(o in d.last){if((n-d.last[o])<=d.interval){return}}var m=timeLengthString((n-d.since)/1000);var q=replaceAll(d.format.away,"{user}",p.user);q=replaceAll(q,"{timesince}",m);b.say(p.ns,replaceAll(q,"{reason}",d.reason));d.last[o]=n};var j=function(){d.format.setaway=f.get("setaway","/me is away: {reason}");d.format.setback=f.get("setback","/me is back");
d.format.away=f.get("away","{user}: I've been away for {timesince}. Reason: {reason}");d.interval=parseInt(f.get("interval",60000))};var g=function(){f.set("interval",d.interval);f.set("setaway",d.format.setaway);f.set("setback",d.format.setback);f.set("away",d.format.away)};l()};wsc.defaults.Extension.Ignore=function(d){var f={};var g=d.storage.folder("ignore");var a=g.folder("ignored");var l=function(){k();j();d.bind("cmd.ignore",b);d.bind("cmd.unignore",h)};var b=function(p){var r=p.args.split(" ");var m="";var q="";var o=false;for(var n in r){if(!r.hasOwnProperty(n)){continue}m=r[n];tmod=d.mute_user(m);if(!tmod){continue}o=tmod;q=replaceAll(f.ignore,"{user}",m);if(q.indexOf("/me ")==0){q=q.substr(4);d.action(p.target,q)}else{d.say(p.target,q)}}if(o){j()}};var h=function(q){var t=q.args.split(" ");var n="";var s="";var m=-1;var p=false;var r=false;for(var o in t){if(!t.hasOwnProperty(o)){continue}n=t[o];r=d.unmute_user(n);if(!r){continue}p=r;s=replaceAll(f.unignore,"{user}",n);if(s.indexOf("/me ")==0){s=s.substr(4);
d.action(q.target,s)}else{d.say(q.target,s)}}if(p){j()}};var k=function(){f.ignore=g.get("ignore","/me is ignoring {user} now");f.unignore=g.get("unignore","/me is not ignoring {user} anymore");f.count=parseInt(g.get("count",0));var n=null;if(f.count>0){n=null;for(var m=0;m<f.count;m++){}}};var j=function(){g.set("ignore",f.ignore);g.set("unignore",f.unignore);for(var m=0;m<f.count;m++){a.remove(m)}};l()};wsc.Client=function(b,d,f){this.mozilla=f;this.storage=new wsc.Storage;this.storage.ui=this.storage.folder("ui");this.storage.aj=this.storage.folder("autojoin");this.storage.aj.channel=this.storage.aj.folder("channel");this.fresh=true;this.attempts=0;this.connected=false;this.protocol=null;this.flow=null;this.ui=null;this.events=new EventEmitter();this.conn=null;this.channelo={};this.cchannel=null;this.cmds=[];this.settings={domain:"website.com",server:"ws://website.com/wsendpoint",symbol:"",username:"",userinfo:{},pk:"",monitor:["~Monitor",true],welcome:"Welcome to the wsc web client!",autojoin:"chat:channel",protocol:wsc.Protocol,mparser:wsc.MessageParser,flow:wsc.Flow,extend:[wsc.defaults.Extension],client:"chatclient",clientver:"0.3",developer:false};
this.autojoin={on:true,count:0,channel:[]};this.away={};var a=this;this.exclude=new StringSet();this.hidden=new StringSet();this.settings=Object.extend(this.settings,d);this.config_load();this.config_save();this.mw=new wsc.Middleware();this.settings.agent="Client ("+navigator.platform+"; HTML5; JavaScript) wsc/"+wsc.VERSION+"-r"+wsc.REVISION;this.mns=this.format_ns(this.settings.monitor[0]);this.lun=this.settings.username.toLowerCase();this.protocol=new this.settings.protocol(new this.settings.mparser());this.flow=new this.settings.flow(this.protocol);this.build();wsc.defaults.Extension(this)};wsc.Client.prototype.config_load=function(){this.settings.developer=(this.storage.get("developer",this.settings.developer.toString())=="true");this.autojoin.on=(this.storage.aj.get("on","true")=="true");this.autojoin.count=parseInt(this.storage.aj.get("count","0"));this.autojoin.channel=[];var a=null;var d=0;for(var b=0;b<this.autojoin.count;b++){a=this.storage.aj.channel.get(b,null);if(a==null){continue
}d++;this.autojoin.channel.push(a)}this.autojoin.count=d};wsc.Client.prototype.config_save=function(){this.storage.set("developer",this.settings.developer);this.storage.aj.set("on",this.autojoin.on.toString());this.storage.aj.set("count",this.autojoin.count);for(var a=0;a<this.autojoin.count;a++){this.storage.aj.channel.remove(a)}if(this.autojoin.channel.length==0){this.storage.aj.set("count",0)}else{var b=-1;for(var a in this.autojoin.channel){if(!this.autojoin.channel.hasOwnProperty(a)){continue}b++;this.storage.aj.channel.set(b.toString(),this.autojoin.channel[a])}b++;this.storage.aj.set("count",b)}};wsc.Client.prototype.build=function(){this.create_ns(this.settings.monitor[0],true,true);var a=this};wsc.Client.prototype.loop=function(){};wsc.Client.prototype.add_extension=function(a){this.settings.extend.push(a);a(this)};wsc.Client.prototype.bind=function(b,a){this.events.addListener(b,a);if(b.indexOf("cmd.")!=0||b.length<=4){return}cmd=b.slice(4).toLowerCase();this.cmds.push(cmd)};wsc.Client.prototype.clear_listeners=function(a){this.events.removeListeners(a)
