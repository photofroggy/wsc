...
}return d.join("")};Chatterbox.Popup.ItemPicker.Page.prototype.show=function(){this.tab.addClass("selected");this.view.css("display","block");this.refresh()};Chatterbox.Popup.ItemPicker.Page.prototype.hide=function(){this.tab.removeClass("selected");this.view.css("display","none")};Chatterbox.Protocol=function(){this.messages={chatserver:{keys:["version"],template:'<span class="servermsg">** Connected to llama {version} *</span>',global:true},dAmnServer:{keys:["version"],template:'<span class="servermsg">** Connected to dAmnServer {version} *</span>',global:true},login:{keys:["username","e","data"],template:'<span class="servermsg">** Login as {username}: "{e}" *</span>',global:true},join:{keys:["ns","e"],template:'<span class="servermsg">** Join {ns}: "{e}" *</span>',monitor:true},part:{keys:["ns","e","r"],template:'<span class="servermsg">** Part {ns}: "{e}" * <em>{r}</em></span>',monitor:true},property:{keys:["ns","p","by","ts","value"],template:'<span class="servermsg">** Got {p} for {ns} *</span>',monitor:true},recv_msg:{keys:["user","message"],template:'<span class="cmsg user u-{user}"><strong>&lt;{user}&gt;</strong></span><span class="cmsg u-{user}">{message}</span>'},recv_action:{keys:["s","user","message"],template:'<span class="caction user u-{user}"><em>* {user}</em></span><span class="caction u-{user}">{message}</span>'},recv_join:{keys:["user","s","info"],template:'<span class="cevent bg">** {user} has joined *</span>',},recv_part:{keys:["user","r"],template:'<span class="cevent bg">** {user} has left * <em>{r}</em></span>'},recv_privchg:{keys:["user","s","by","pc"],template:'<span class="cevent">** {user} has been made a member of {pc} by {by} *</span>'},recv_kicked:{keys:["user","s","by","r"],template:'<span class="cevent">** {user} has been kicked by {by} * <em>{r}</em></span>'},recv_admin_create:{keys:["p","user","pc","privs"],template:'<span class="cevent admin">** Privilege class {pc} has been created by {user} * <em>{privs}</em></span>'},recv_admin_update:{keys:["p","user","pc","privs"],template:'<span class="cevent admin">** Privilege class {pc} has been updated by {user} * <em>{privs}</em></span>'},recv_admin_rename:{keys:["p","user","prev","pc"],template:'<span class="cevent admin">** Privilege class {prev} has been renamed to {pc} by {user} *</span>'},recv_admin_move:{keys:["p","user","prev","pc","affected"],template:'<span class="cevent admin">** All members of {prev} have been moved to {pc} by {user} * <em>{affected} affected user(s)</em></span>'},recv_admin_remove:{keys:["p","user","pc","affected"],template:'<span class="cevent admin">** Privilege class {pc} has been removed by {user} * <em>{affected} affected user(s)</em></span>'},recv_admin_show:null,recv_admin_showverbose:null,recv_admin_privclass:{keys:["p","e","command"],template:'<span class="cevent admin">** Admin command "{command}" failed * <em>{e}</em></span>'},kicked:{keys:["ns","user","r"],template:'<span class="servermsg">** You have been kicked by {user} * <em>{r}</em></span>'},ping:null,disconnect:{keys:["e"],template:'<span class="servermsg">** You have been disconnected * <em>{e}</em></span>',global:true},send:{keys:["ns","e"],template:'<span class="servermsg">** Send error: <em>{e}</em></span>'},kick:{keys:["ns","user","e"],template:'<span class="servermsg">** Could not kick {user} * <em>{e}</em></span>'},get:{keys:["ns","p","e"],template:'<span class="servermsg">** Could not get {p} info for {ns} * <em>{e}</em></span>'},set:{keys:["ns","p","e"],template:'<span class="servermsg">** Could not set {p} * <em>{e}</em></span>'},kill:{keys:["ns","e"],template:'<span class="servermsg">** Kill error * <em>{e}</em></span>'},unknown:{keys:["ns","packet"],template:'<span class="servermsg">** Received unknown packet in {ns} * <em>{packet}</em></span>',monitor:true}}
};Chatterbox.Protocol.prototype.extend_messages=function(b){for(var a in b){this.messages[a]=b[a]}};Chatterbox.Protocol.prototype.log=function(b){var a=this.messages[b.name];return new Chatterbox.Protocol.LogMessage(b,a)};Chatterbox.Protocol.LogMessage=function(b,a){a=a||{};this.event=b;this.template=a.template||"";this.keys=a.keys||[];this.monitor=a.monitor||false;this.global=a.global||false;this._html=false;this._text=false;this._ansi=false};Chatterbox.Protocol.LogMessage.prototype.text=function(){if(this._text===false){this._text=this.render(0)}return this._text};Chatterbox.Protocol.LogMessage.prototype.html=function(){if(this._html===false){this._html=this.render(1)}return this._html};Chatterbox.Protocol.LogMessage.prototype.ansi=function(){if(this._ansi===false){this._ansi=this.render(2)}return this._ansi};Chatterbox.Protocol.LogMessage.prototype.render=function(f){if(f===undefined){f=0}var b=this.template;var g="";for(var a in this.keys){if(!this.keys.hasOwnProperty(a)){continue}key=this.keys[a];
if(key instanceof Array){key=key[1]}if(!this.event.hasOwnProperty(key)||key=="pkt"){continue}g=this.event[key];if(g==null){continue}if(key=="ns"||key=="sns"){key="ns";g=this.event.sns}if(g.hasOwnProperty("_parser")){switch(f){case 1:g=g.html();break;case 2:g=g.ansi();break;case 0:default:g=g.text();break}}b=replaceAll(b,"{"+key+"}",g)}return b};Chatterbox.Settings=function(b,a){Chatterbox.Popup.call(this,b,{ref:"settings",title:"Settings",close:false,content:""});this.config=a;this.saveb=null;this.scb=null;this.tabs=null;this.book=null;this.changed=false;this.manager=b};Chatterbox.Settings.prototype=new Chatterbox.Popup();Chatterbox.Settings.prototype.constructor=Chatterbox.Settings;Chatterbox.Settings.prototype.build=function(){this.options.content=Chatterbox.template.settings.main;Chatterbox.Popup.prototype.build.call(this);this.saveb=this.window.find("a.button.save");this.closeb=this.window.find("a.close");this.scb=this.window.find("a.button.saveclose");this.tabs=this.window.find("nav.tabs ul.tabs");
