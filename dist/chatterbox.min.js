...
}var g=this.el.m.find("div.chatusers");var a=null;for(var b in h){a=h[b];this.set_user(a)}var e=0;var d=0;g.find("div.pc").each(function(c,j){d=g.find(this).find("ul li").length;e+=d;if(d==0){g.find(this).css("display","none");return}g.find(this).css("display","block")});g.css("display",(e==0?"none":"block"));var f=this;setTimeout(function(){f.resize()},100)};Chatterbox.Channel.prototype.set_user=function(b){var e=this.el.m.find("div.chatusers div.pc#"+b.pc);var a=e.find("ul");a.append('<li><a target="_blank" id="'+b.name+'" href="http://'+b.name+"."+this.manager.settings.domain+'"><em>'+b.symbol+"</em>"+b.name+"</a>"+b.conn+"</li>");var d=this;this.manager.cascade("user.hover",function(c){d.userinfo(c)},b.hover);if(a.find("li").length>0){e.css("display","block")}};Chatterbox.Channel.prototype.highlight=function(c){var a=this.el.t.o;if(c!==false){(c||this.el.l.w.find(".logmsg").last()).addClass("highlight")}if(a.hasClass("active")){if(!this.manager.viewing){this.manager.sound.click()}return
}if(!this.hidden){this.manager.sound.click()}if(a.hasClass("tabbed")){return}if(a.hasClass("chatting")){a.removeClass("chatting")}var d=0;a.addClass("tabbed");function b(){d++;a.toggleClass("fill");if(d==6){return}setTimeout(b,1000)}b()};Chatterbox.Channel.prototype.noise=function(){var b="";var a=0;var d=this.el.m.find(".logmsg").last();for(var c in this.manager.umuted){if(!this.manager.umuted.hasOwnProperty(c)){continue}if(d.hasClass("u-"+this.manager.umuted[c])){d.css({display:"none"});this.scroll();return}}if(!this.el.t.o.hasClass("active")){this.el.t.o.addClass("noise");if(!this.el.t.o.hasClass("tabbed")){if(d.find(".cevent").length==0){this.el.t.o.addClass("chatting")}}}};Chatterbox.Channel.prototype.userinfo=function(a){var c=this.el.m.find("a#"+a.name);if(c.length==0){return}var d=this;var b=null;c.hover(function(h){a.info=[];var f={ns:d.namespace,user:a};d.manager.trigger("userinfo.before",f);a=f.user;var g="";for(index in a.info){g+="<li>"+a.info[index]+"</li>"}d.window.append(Chatterbox.render("userinfo",{username:a.name,avatar:a.avatar,link:a.link,info:g}));
