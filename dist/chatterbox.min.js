...
this.field=this.view.find("input:checkbox");var a=this;this.value=[];this.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())});this.field.bind("change",function(e){a.value=[];a.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())})})};Chatterbox.Settings.Item.Items=function(b,a,c){Chatterbox.Settings.Item.call(this,b,a,c);this.selected=false};Chatterbox.Settings.Item.Items.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Items.prototype.constructor=Chatterbox.Settings.Item.Items;Chatterbox.Settings.Item.Items.prototype.build=function(b){Chatterbox.Settings.Item.prototype.build.call(this,b);var a=this;this.list=this.view.find("ul");this.buttons=this.view.find("section.buttons p");var c=this.list.find("li");c.click(function(f){var e=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=e.find(".item").html();e.addClass("selected")});c.each(function(e,g){var f=a.list.find(g);
f.find("a.close").click(function(h){a.list.find("li.selected").removeClass("selected");a.selected=f.find(".item").html();f.addClass("selected");a.remove_item();return false})});this.buttons.find("a.button.up").click(function(e){a.shift_item(true);return false});this.buttons.find("a.button.down").click(function(e){a.shift_item();return false});this.buttons.find("a.button.add").click(function(f){var e=new Chatterbox.Popup.Prompt(a.manager,{title:"Add item",label:"Item:"});e.build();return false});this.buttons.find("a.button.close").click(function(e){a.remove_item();return false})};Chatterbox.Settings.Item.Items.prototype.shift_item=function(b){if(this.selected===false){return}var c=this.options.items.indexOf(this.selected);var a=c+1;if(b){a=c-1}if(c==-1||c>=this.options.items.length){return}if(a<0||a>=this.options.items.length){return}this._fevent((b?"up":"down"),{swap:{"this":{index:c,item:this.options.items[c]},that:{index:a,item:this.options.items[a]}}});this.refresh();this._onchange({});
return};Chatterbox.Settings.Item.Items.prototype.remove_item=function(){if(this.selected===false){return false}var a=this.options.items.indexOf(this.selected);if(a==-1||a>=this.options.items.length){return false}this._fevent("remove",{index:a,item:this.selected});this.refresh();this._onchange({})};Chatterbox.Settings.Item.Items.prototype.refresh=function(){this.view.find("section.mitems").html(Chatterbox.template.settings.krender.manageditems(this.options.items));this.list=this.view.find("ul");this.list.find("li[title="+(this.selected||"").toLowerCase()+"]").addClass("selected");var a=this;var b=this.list.find("li");b.click(function(e){var c=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=c.find(".item").html();c.addClass("selected")});b.each(function(c,f){var e=a.list.find(f);e.find("a.close").click(function(g){a.list.find("li.selected").removeClass("selected");a.selected=e.find(".item").html();e.addClass("selected");a.remove_item();return false})})};Chatterbox.Settings.Item.Items.prototype._fevent=function(b,e){var g=this._get_ep("inspect");
var c=g?this.view.find(g[1]):null;var a=this._get_cb(b);if(typeof a=="function"){a({input:c,item:this,args:e})}else{for(var f in a){var h=c.hasOwnProperty("slice")?c.slice(f,1):c;a[f]({input:h,item:this,args:e})}}};Chatterbox.Settings.Item.Items.prototype.save=function(){this._fevent("save",{items:this.options.items||[]})};Chatterbox.template={};Chatterbox.render=function(e,g){var c=Chatterbox.template;var b=e.split(".");var f={};var a=null;for(ind in b){part=b[ind];if(!c.hasOwnProperty(part)){return""}c=c[part]}if(c.hasOwnProperty("frame")){a=c;f=c.render||{};c=c.frame;if(a.hasOwnProperty("pre")){if(typeof a.pre=="function"){c=a.pre(c,g)}else{for(i in a.pre){c=a.pre[i](c,g)}}}}for(key in g){c=replaceAll(c,"{"+key+"}",(f[key]||Chatterbox.template.render_stub)(g[key]||""))}if(a!=null){if(a.hasOwnProperty("post")){if(typeof a.post=="function"){c=a.post(c,g)}else{for(i in a.post){c=a.post[i](c,g)}}}}return c};Chatterbox.template.render_stub=function(a){return a};Chatterbox.template.clean=function(a){return function(b,c){for(i in a){b=replaceAll(b,"{"+a[i]+"}","")
