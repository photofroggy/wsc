...
};Chatterbox.Settings.Item.prototype.resize=function(){for(var a in this.items){this.items[a].resize()}};Chatterbox.Settings.Item.prototype.hooks=function(c){if(!this.options.hasOwnProperty("event")){return}var b=this.options.event;var e=Chatterbox.template.settings.item.get(this.selector);if(e==false){return}if(!e.hasOwnProperty("events")){return}var d=[];for(var a in e.events){d=e.events[a];if(!b.hasOwnProperty(d[0])){continue}c.find(d[1]).bind(d[0],b[d[0]])}};Chatterbox.Settings.Item.prototype._event_stub=function(){};Chatterbox.Settings.Item.prototype._get_cb=function(a){if(!this.options.hasOwnProperty("event")){return this._event_stub}return this.options.event[a]||this._event_stub};Chatterbox.Settings.Item.prototype._get_ep=function(b){var d=Chatterbox.template.settings.item.get(this.selector);if(d==null){return false}if(!d.hasOwnProperty("events")){return false}var c=[];for(var a in d.events){c=d.events[a];if(c[0]==b){return c}}};Chatterbox.Settings.Item.prototype.save=function(d,e){var f=this._get_ep("inspect");
var b=f?this.view.find(f[1]):null;var a=this._get_cb("save");if(typeof a=="function"){a({input:b,item:this,page:e,window:d})}else{for(var c in a){var g=b.hasOwnProperty("slice")?b.slice(c,1):b;a[c]({input:g,item:this,page:e,window:d})}}for(var c in this.items){this.items[c].save(d,e)}};Chatterbox.Settings.Item.prototype.close=function(d,e){var f=this._get_ep("inspect");var b=f?this.view.find(f[1]):null;var a=this._get_cb("close");if(typeof a=="function"){a({input:b,item:this,page:e,window:d});return}for(var c in a){var g=b.hasOwnProperty("slice")?b.slice(c,1):b;a[c]({input:g,item:this,page:e,window:d})}for(var c in this.items){this.items[c].close(d,e)}};Chatterbox.Settings.Item.get=function(e,j,f,b,a){var d=e.split(".");var g=b||Chatterbox.Settings.Item;var h;for(var c in d){h=d[c];if(!g.hasOwnProperty(h)){g=a||Chatterbox.Settings.Item;break}g=g[h]}return new g(e,j,f)};Chatterbox.Settings.Item.Form=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.form=null;this.fields=[];this.lsection=null;
this.fsection=null;this.fieldo={}};Chatterbox.Settings.Item.Form.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Form.prototype.constructor=Chatterbox.Settings.Item.Form;Chatterbox.Settings.Item.Form.field=function(b,a){return Chatterbox.Settings.Item.get(b,a,this.manager,Chatterbox.Settings.Item.Form,Chatterbox.Settings.Item.Form.Field)};Chatterbox.Settings.Item.Form.prototype.build=function(d){Chatterbox.Settings.Item.prototype.build.call(this,d);if(this.view==null){return}this.lsection=this.view.find("section.labels");this.fsection=this.view.find("section.fields");if(!this.options.hasOwnProperty("fields")){return}var c;var e;for(var a in this.options.fields){c=this.options.fields[a];e=Chatterbox.Settings.Item.Form.field(c[0],c[1]);this.fields.push(e);e.build(this);if(c[1].hasOwnProperty("ref")){this.fieldo[c[1].ref]=e}}this.form=this.view.find("form");var b=this;this.form.bind("change",function(f){b.change()})};Chatterbox.Settings.Item.Form.prototype.resize=function(){for(var a in this.fields){this.fields[a].resize()
}};Chatterbox.Settings.Item.Form.prototype.change=function(){var c={};var d;for(var b in this.fields){d=this.fields[b];c[d.ref]=d.get()}var a=this._get_cb("change");if(typeof a=="function"){a({data:c,form:this})}else{for(var b in a){a[b]({data:c,form:this})}}};Chatterbox.Settings.Item.Form.prototype.save=function(d,f){var e={};var b;for(var c in this.fields){field=this.fields[c];e[field.ref]=field.get()}var a=this._get_cb("save");if(typeof a=="function"){a({data:e,form:this,page:f,window:d})}else{for(var c in a){a[c]({data:e,form:this,page:f,window:d})}}};Chatterbox.Settings.Item.Form.prototype.close=function(c,e){var d={};var f;for(var b in this.fields){f=this.fields[b];d[f.ref]=f.get()}var a=this._get_cb("close");if(typeof a=="function"){a({data:d,form:this,page:e,window:c})}else{for(var b in a){a[b]({data:d,form:this,page:e,window:c})}}};Chatterbox.Settings.Item.Form.Field=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.ref=this.options.ref||"ref";this.label=null;this.field=null;
...
Chatterbox.Settings.Item.Form.Colour.prototype.build=function(a){Chatterbox.Settings.Item.Form.Field.prototype.build.call(this,a);this.resize()};Chatterbox.Settings.Item.Form.Colour.prototype.resize=function(){this.lwrap.height(this.fwrap.height())};Chatterbox.Settings.Item.Radio=function(b,a){Chatterbox.Settings.Item.call(this,b,a);this.value=""};Chatterbox.Settings.Item.Radio.prototype=new Chatterbox.Settings.Item();Chatterbox.Settings.Item.Radio.prototype.constructor=Chatterbox.Settings.Item.Radio;Chatterbox.Settings.Item.Radio.prototype.build=function(c){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,c);this.field=this.view.find("input:radio");this.value=this.view.find("input[checked]:radio").val();var a=this;this.field.bind("change",function(d){a.value=a.view.find(this).val()})};Chatterbox.Settings.Item.Checkbox=function(b,a){Chatterbox.Settings.Item.Radio.call(this,b,a);
this.value=[]};Chatterbox.Settings.Item.Checkbox.prototype=new Chatterbox.Settings.Item.Radio();Chatterbox.Settings.Item.Checkbox.prototype.constructor=Chatterbox.Settings.Item.Checkbox;Chatterbox.Settings.Item.Checkbox.prototype.build=function(c){if(this.options.hasOwnProperty("items")){for(i in this.options.items){var b=this.options.items[i];b.name=this.options.ref||"ref"}}Chatterbox.Settings.Item.prototype.build.call(this,c);this.field=this.view.find("input:checkbox");var a=this;this.value=[];this.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())});this.field.bind("change",function(d){a.value=[];a.view.find("input[checked]:checkbox").each(function(){a.value.push(a.view.find(this).val())})})};Chatterbox.Settings.Item.Items=function(b,a,c){a=Object.extend({prompt:{title:"Add Item",label:"Item:","submit-button":"Add"}},(a||{}));Chatterbox.Settings.Item.call(this,b,a,c);this.selected=false};Chatterbox.Settings.Item.Items.prototype=new Chatterbox.Settings.Item();
Chatterbox.Settings.Item.Items.prototype.constructor=Chatterbox.Settings.Item.Items;Chatterbox.Settings.Item.Items.prototype.build=function(b){Chatterbox.Settings.Item.prototype.build.call(this,b);var a=this;this.list=this.view.find("ul");this.buttons=this.view.find("section.buttons p");var c=this.list.find("li");c.click(function(e){var d=a.list.find(this);a.list.find("li.selected").removeClass("selected");a.selected=d.find(".item").html();d.addClass("selected")});c.each(function(d,f){var e=a.list.find(f);e.find("a.close").click(function(g){a.list.find("li.selected").removeClass("selected");a.selected=e.find(".item").html();e.addClass("selected");a.remove_item();return false})});this.buttons.find("a.button.up").click(function(d){a.shift_item(true);return false});this.buttons.find("a.button.down").click(function(d){a.shift_item();return false});this.buttons.find("a.button.add").click(function(d){var e=new Chatterbox.Popup.Prompt(a.manager,{position:[d.clientX-100,d.clientY-50],title:a.options.prompt.title,label:a.options.prompt.label,"submit-button":a.options.prompt["submit-button"],event:{submit:function(f){var h=f.data;
